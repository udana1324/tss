                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab_pane_1" role="tabpanel" aria-labelledby="tab_pane_1">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset>
                                                <legend class="text-muted"><h6><i class="la la-clipboard-list"></i> Informasi Grup Customer </h6></legend>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" id="grup" value="{{strtoupper($dataCustomerGroup->nama_group)}}" readonly>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                <legend class="text-muted"><h6><i class="la la-clipboard-list"></i> Informasi Tagihan Grup Customer </h6></legend>
                                                <div class="separator separator-solid separator-border-2 separator-muted"></div>
                                                <br>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_item').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/AccountReceiveable/GetDetailGroup',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
                            data : {
                                idGroup : '{{$dataCustomerGroup->id}}',
                            },
                        }
                    },
                    pageSize: 20,
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            var txt = "";
                                txt += '<span class="font-weight-bolder">'+row.nama_customer.toUpperCase()+'</span><br />';
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_item_lunas').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/AccountReceiveable/GetDetailLunasGroup',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
                    ...
                    if (result.length > 0) {
                        ...
                        for (var i = 0; i < result.length;i++) {
                            ...
                            var data="<tr>";
                                ...
                                if (result[i].rekening == "" || result[i].rekening == null) {
                        ...
                        $.ajax({
                            ...
                            success: function(result){
                                if (result == "success") {
                                    ...
                                    clear();
                                    var datatable = $('#list_item').KTDatatable();
                                        datatable.setDataSourceParam('idGroup', '{{$dataCustomerGroup->id}}');
                                        datatable.reload();
                                    ...
                                    Swal.fire(
                                        "Gagal!",
                                        "Pembayaran Gagal Diinput! Silahkan hubungi admin!.",
                                        "warning"
                                    )
                                }
                            }
        ...
        function getDataTagihan(idGroup) {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                url: "/AccountReceiveable/GetTagihanByCustomerGroup",
                method: 'POST',
                data: {
                    id_grup: '{{$dataCustomerGroup->id}}',
                },
                success: function(result){
                    if (result != null) {
			...
			if (errCount == 0) {
                Swal.fire({
                    ...
                    if(result.value) {
                        ...
                        $.ajax({
                            url: "/AccountReceiveable/StoreDetailMassGroup",
                            method: 'POST',
                            dataType : 'json',
                            data: {
                                idGroup : "{{$dataCustomerGroup->id}}",
                            ...
                            success: function(result){
                                if (result == "success") {
                                    ...
                                    var datatable2 = $('#list_item_lunas').KTDatatable();
                                        datatable2.setDataSourceParam('idGroup', '{{$dataCustomerGroup->id}}');
                                        datatable2.reload();
                                    getDataTagihan();
                                    ListPayment(idInv);
                                }
