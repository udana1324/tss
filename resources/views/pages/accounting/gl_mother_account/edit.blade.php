	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom card-sticky">
                    ...
                    <form action="{{ route('GLMotherAccount.update', $dataAccount->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
                                <legend class="font-weight-semibold"> Ubah Mother Account</legend>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Nomor Account" name="account_number" class="form-control req" autocomplete="off" value="{{$dataAccount->account_number}}">
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Nama Account" name="account_name" class="form-control req" value="{{$dataAccount->account_name}}" autocomplete="off">
...
@section('scripts')
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#default_side").val("{{$dataAccount->default_side}}").trigger("change");
            $("#group").val("{{$dataAccount->group}}").trigger("change");
        });
