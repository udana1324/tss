	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom">
                    ...
                    <form action="{{ route('TaxSerialNumber.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan No. Permohonan" id="no_permohonan" name="no_permohonan" class="form-control req">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Nomor Pemberitahuan" id="no_pemberitahuan" name="no_pemberitahuan" class="form-control req">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" maxlength="4" onkeypress="return validasiAngka(event);" placeholder="Masukkan Tahun Pajak" id="tahun_pajak" name="tahun_pajak" class="form-control req">
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control req" maxlength="4" onkeypress="return validasiAngka(event);" name="jumlah_seri" id="jumlah_seri" readonly>
                                                <span class="form-text text-danger err" style="display:none;">*Harap Masukkan nomor permohonan terlebih dahulu!</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Nomor Awal Seri Faktur Pajak" id="seri_awal" name="seri_awal" class="form-control sfp req" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Nomor Akhir Seri Faktur Pajak" id="seri_akhir" name="seri_akhir" class="form-control sfp req" autocomplete="off">
