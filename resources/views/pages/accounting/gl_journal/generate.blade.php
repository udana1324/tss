			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Generate Jurnal</h6>
					</div>
								...
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label">Account Setting :</label>
                                            <div class="col-lg-9">
                                                <select class="form-control select2 req" id="setting" name="setting">
                                                    <option label="Label"></option>
                                                    @foreach($accountSetting as $setting)
                                                    <option value="{{$setting->id}}">{{ucwords($setting->module)}}</option>
                                                    @endforeach
                                                </select>
                                                <span class="form-text text-danger err" style="display:none;">*Harap pilih account setting terlebih dahulu!</span>
                                            </div>
                                        </div>
					...
					<div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2> <strong><p>Jurnal</p></strong></h2>
                                ...
                                <table id="tblData" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Nomor Account</th>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblFooter" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="text-center" colspan="3">Total</th>
                                            <th class="text-center"><p id="ttlDebet"></p></th>
                                            <th class="text-center"><p id="ttlCredit"></p></th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#setting').select2({
                allowClear: true,
                placeholder: "Silahkan Pilih Account Setting yang akan di generate"
            });
                ...
                if (errCount == 0) {
                    Swal.fire({
                        ...
                        if(result.value) {
                            ...
                            $.ajax({
                                url: "/GLJournal/ExecuteGenerate",
                                method: 'POST',
                                data: {
                                    id_setting: $("#setting").val(),
                                ...
                                success: function(result){
                                    if (result.length > 0) {
                                        ...
                                        // var jmlTtl = 0;
                                        // console.log(result);
                                        // console.log(result[1].dataJournal);
                                        if (result[1].dataJournal != null) {
                                            Swal.fire(
                                                "Success!",
                                                "Sukses generate Jurnal",
                                                "success"
                                            );
                                        }
                                        else {
