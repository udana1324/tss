			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Entri Bank</h6>
					</div>
                    <form action="{{ route('GLKasBank.update', $dataKasBank->id) }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
                                            ...
                                            <div class="col-md-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="bank" value="2" name="id_account" {{$dataKasBank->id_account == "2" ? "checked" : ""}} />
                                                            <span></span>Bank
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="masuk" value="1" name="jenis_transaksi" {{$dataKasBank->jenis_transaksi == "1" ? "checked" : ""}} />
                                                            <span></span>Masuk
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" id="keluar" value="2" name="jenis_transaksi" {{$dataKasBank->jenis_transaksi == "2" ? "checked" : ""}} />
                                                            <span></span>keluar
                                                        </label>
                                                    </div>
                                                </div>
								...
								<div class="col-lg-6">
									<fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="nominalTransaksiMask" autocomplete="off" data-a-dec="," data-a-sep="." class="form-control text-right req" value="{{$dataKasBank->nominal_transaksi}}" >
                                                <input type="hidden" id="nominalTransaksi" name="nominal_transaksi" class="form-control text-right" value="{{$dataKasBank->nominal_transaksi}}" >
                                            </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            getSubAccount("{{$dataKasBank->id_account}}");
            getSubAccountBiaya();
                        ...
                        $.ajax({
                            ...
                            success: function(result){
                                if (result == "success") {
                                    ...
                                    var datatable = $('#list_item').KTDatatable();
                                        datatable.setDataSourceParam('idKasBank', "{{$dataKasBank->id}}");
                                        datatable.reload();
                                    footerDataForm("{{$dataKasBank->id}}");
                                }
            ...
            $.ajax({
                ...
                success: function(result){
                    if (result != null || result != "") {
                        ...
                        $("#id_account_biaya_edit").val(result.value2).trigger("change");

                        $("#nominalEditMask").val(parseFloat(result.value3).toLocaleString('id-ID', { maximumFractionDigits: 2}));
                        $("#nominalEdit").val(result.value3);

                        $("#keteranganEdit").val(result.value4);
        ...
        function getSubAccount(idAccount) {
            ...
            $.ajax({
                ...
                success: function(result){
                    ...
                    $("#id_account_sub").val("{{$dataKasBank->id_account_sub}}").trigger("change");
                }
            });
        }
        ...
        $('input[name=id_account]').on('change', function() {
			var val = $(this).val();
            $("#id_account_kasbank").val(val);
			getSubAccount(val);
            getSubAccountBiaya();
		});
