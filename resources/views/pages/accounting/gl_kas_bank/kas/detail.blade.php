			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Detail Entri Kas</h6>
					</div>
                                            ...
                                            <div class="col-md-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="kas" value="1" name="id_account" {{$dataKasBank->id_account == "1" ? "checked" : ""}} disabled="disabled" />
                                                            <span></span>Kas
                                                        </label>
                                                    </div>
                                                </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(".btnSubmit").on("click", function(e){
            ...
            if (btn == "posting") {
                Swal.fire({
                    title: "Posting Entri Kas",
                    //text: "Apakah yakin ingin melakukan Pembatalan Invoice Penjualan?",
                    html: "Apakah yakin ingin melakukan Posting Entri Kas?" + "<br /><br />" +
                ...
                Swal.fire({
                    title: ucwords(btn) + " Entri Kas?",
                    text: "Apakah yakin ingin melakukan " + ucwords(btn) +" Entri Kas?",
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonText: "Ya",
                    cancelButtonText: "Tidak",
