			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h5 class="card-title text-white">Tambah Sub Account</h5>
					</div>
                    <form action="{{ route('GLSubAccount.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-5">Sub Account Name</label>
                                            <div class="col-sm-12">
