				...
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('asset('media/bg/bg-3.jpg')}}');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							<div class="mb-20">
								<h3>Login</h3>
								<div class="text-muted font-weight-bold">Masukkan Username dan Password untuk Login</div>
							</div>
                            <form class="form" id="kt_login_signin_form" method="POST" action="{{ url('/main/checklogin') }}">
                                {{ csrf_field() }}
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Username" name="user_name" autocomplete="off" />
								</div>
								<div class="form-group mb-5">
