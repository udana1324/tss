	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom">
                    ...
                    <form action="{{ route('PurchaseInvoiceCollection.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12 ml-0 pl-0">
                                                <input type="text" id="pic" name="pic" class="form-control req">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <textarea class="form-control elastic" id="tnc" name="tnc" rows="3" placeholder="Ketik Syarat & Ketentuan Tukar Faktur Disini atau gunakan Template pada tombol Template"></textarea>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function getInvoiceDate(idInv) {
            ...
            $.ajax({
                url: "/PurchaseInvoiceCollection/GetInvoiceDate",
                method: 'POST',
                data: {
                    idInvoice: idInv,
                },
