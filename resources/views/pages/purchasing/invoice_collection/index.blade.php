				...
				<div class="card card-custom">
					<div class="card-header bg-primary header-elements-sm-inline">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            @if($hakAkses->add == "Y")
                            <button class="btn btn-primary btn-outline-white mr-2" onclick="window.location.href = '{{ url('PurchaseInvoiceCollection/Add') }}';">
                                <i class="flaticon2-plus"></i>
                                Buat Baru
                            </button>
                            @endif
                            @if($hakAkses->export == "Y")
                            <button type="button" class="btn btn-success font-weight-bold mr-2" id="btnExport" onclick="ExportExcel('T','table_inv_col_purchase','Tukar Faktur','xlsx');"> Export <i class="fas fa-file-excel"></i></button>
                            @endif
                            <!--end::Button-->
                        </div>
					</div>
					...
					<div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-3 my-2 my-md-0">
                                            <div class="align-items-center">
                                                ...
                                                <div class="input-icon">
                                                    <input type="text" class="form-control" placeholder="Search..." id="table_inv_col_purchase_search_query"/>
                                                    <span>
                                        ...
                                        <div class="col-md-4 my-2 my-md-0">
                                            <div class="align-items-center">
                                                ...
                                                <select class="form-control select2" id="table_inv_col_purchase_search_supplier">
                                        ...
                                        <div class="col-md-2 my-2 my-md-0">
                                            <div class="align-items-center">
                                                ...
                                                <select class="form-control select2" id="table_inv_col_purchase_search_status">
                                                    <option value="">All</option>
                        ...
                        <div class="datatable datatable-bordered datatable-head-custom" id="table_inv_col_purchase"></div>
...
@section('scripts')
	<script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#table_inv_col_purchase_search_supplier').select2({
                allowClear: true
            });

            $('#table_inv_col_purchase_search_status').select2({
                allowClear: true
            });
		...
		$(document).ready(function() {
            ...
            var datatable = $('#table_inv_col_purchase').KTDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
                            url: '/PurchaseInvoiceCollection/GetData',
                            method: 'GET',
                ...
                search: {
                    input: $('#table_inv_col_purchase_search_query')
                },
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            var txt = "";
                                txt += '<span class="font-weight-bold">'+row.nama_supplier+'</span><br />';
                        ...
                        template: function(row) {
                            ...
                            if (usergroup.user_group != "operasional") {
                                var txtAction = '<div class="dropdown dropdown-inline">';
                                    ...
                                    txtAction += "<li class='nav-item'><a class='nav-link' href='{{route('PurchaseInvoiceCollection.Detail', 'idInv')}}'><i class='nav-icon la la-eye'></i><span class='nav-text'>Detail</span></a></li>";
                                    if (akses.edit == "Y" && row.status == "draft") {
                                        txtAction += "<li class='nav-item'><a class='nav-link' href='{{route('PurchaseInvoiceCollection.edit', 'idInv')}}'><i class='nav-icon la la-edit'></i><span class='nav-text'>Ubah</span></a></li>";
                                    }
                                    if (akses.delete) {
            ...
            $('#table_inv_col_purchase_search_supplier').on('change', function() {
                datatable.search($(this).val(), 'nama_supplier');
            });

            $('#table_inv_col_purchase_search_status').on('change', function() {
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "/PurchaseInvoiceCollection/Delete",
                        method: 'POST',
                        data: {
                            idPurchaseInvoiceCollection: id
                        },
