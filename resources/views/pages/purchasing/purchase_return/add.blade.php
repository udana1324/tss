			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Buat Retur Pembelian</h6>
					</div>
                    <form action="{{ route('PurchaseReturn.store') }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="nota_retur" id="nota_retur">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset>
                                        <legend class="text-muted"><h6><i class="la la-list"></i> List Retur</h6></legend>
                                        <div class="separator separator-solid separator-border-2 separator-muted"></div>
                                        <br>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ($("#mode").val() == "nota" && idSupp != "") {
                $("#supplier").val(idSupp).trigger("change");
            }
        });
        ...
        function getSupplierReturn(idSupplier) {
            ...
            $.ajax({
                ...
                success: function(result){
                    ...
                    if ($("#mode").val() == "nota") {
                        $("#data_retur").val("{{$idRetur}}").trigger("change");
                        $("#mode").val("tambah");
                        var datatable = $('#list_item').KTDatatable();
                            datatable.setDataSourceParam('idReturn', '');
                            datatable.reload();
