			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Buat Retur Pembelian (Barang)</h6>
					</div>
                    <form action="{{ route('PurchaseReturnItem.store') }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group row d-none">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control bg-slate-600 border-slate-600 border-1" placeholder="Auto Generated" name="kode_so" id="kode_so" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="nmr_sj_retur" id="nmr_sj_retur">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <textarea class="form-control elastic" id="keterangan" name="keterangan" rows="3" placeholder="Ketik keterangan Disini"></textarea>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                ...
                if(result.value) {
                    window.location.href = "{{ url('/PurchaseReturnItem') }}";
                }
        ...
        $("#supplier").on("change", function() {
            ...
            $.ajax({
                url: "/PurchaseReturnItem/ResetDetail",
                method: 'POST',
                data: {
                    idReturn: 'DRAFT',
                },
                success: function(result){
                    var datatable = $('#list_item').KTDatatable();
                        datatable.setDataSourceParam('idReturn', '');
                        datatable.reload();
        ...
        $("#product").on("change", function() {
            ...
            $.ajax({
                url: "/PurchaseReturnItem/GetSatuan",
                method: 'POST',
                data: {
                    idProduct: $(this).val(),
                },
        ...
        $("#productUnit").on("change", function() {
            ...
            $.ajax({
                url: "/PurchaseReturnItem/GetDataItem",
                method: 'POST',
                data: {
                ...
                success: function(result){
                    if (result != "") {
	                  	var stokItem = result;
	                    $("#txtStok").html("Jumlah Total Barang yang Dijual ke Supplier : "+stokItem);
        ...
        function getSupplierProduct(idSupplier) {
            ...
            $.ajax({
                url: "/PurchaseReturnItem/GetProductBySupplier",
                method: 'POST',
                data: {
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_riwayat').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/PurchaseReturnItem/GetProductHistory',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            ...
                            if (row.no_po_supplier != null) {
                                txt += '<span class="font-weight-bold text-inline text-primary font-size-xs">No. PO : '+row.no_po_supplier.toUpperCase()+'</span>';
                            }
                            else {
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_item').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/PurchaseReturnItem/GetDetail',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
			...
			if (errCount == 0) {
                Swal.fire({
                    ...
                    if(result.value) {
                        ...
                        $.ajax({
                            url: "/PurchaseReturnItem/StoreDetail",
                            method: 'POST',
                            dataType : 'json',
                            data: {
        ...
        function editDetailItem(id) {
            ...
            $.ajax({
                url: "/PurchaseReturnItem/EditDetail",
                method: 'POST',
                data: {
                    idDetail: id,
                    idSupp: $("#supplier option:selected").val(),
                },
                success: function(result){
                    if (result != null) {
                        $("#idItemEdit").val(result.id_item);
                        $("#idIndexEdit").val(result.id_index);
                        $("#idSatuanEdit").val(result.id_satuan);
                        $("#idDetail").val(result.id);

                        $("#qty_itemEditMask").val(parseFloat(result.qty_item).toLocaleString('id-ID', { maximumFractionDigits: 2})).trigger('change');
                        ...
                        $("#indexEdit").val(result.id_index).trigger('change');
                        $("#txtStokEdit").html("Jumlah Total Barang yang Dibeli ke Supplier : " + result.limit_retur);
        ...
        function deleteDetailItem(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "/PurchaseReturnItem/DeleteDetail",
                        method: 'POST',
                        data: {
                            idDetail: id
                        },
	    ...
	    $(document).on("click", "#btnEditItem", function(e) {
            ...
            if (parseFloat(qty) > parseFloat(limit)) {
                Swal.fire(
                    "Gagal!",
                    "Jumlah Item Tidak dapat melebihi total pembelian kepada supplier!",
                    "warning"
                );
                return false;
            }
            ...
            if (errCount == 0) {
                Swal.fire({
                    ...
                    if(result.value) {
                        ...
                        $.ajax({
                            url: "/PurchaseReturnItem/UpdateDetail",
                            method: 'POST',
                            dataType : 'json',
                            data: {
                                idItem : idItem,
        ...
        function footerDataForm(idReturn) {
            ...
            $.ajax({
                url: "/PurchaseReturnItem/GetDataFooter",
                method: 'POST',
                data: {
                    idReturn: idReturn,
                },
