...
@section('content')
	...
	@include('pages.alerts')
			<div class="content">
                <form action="{{ route('Receiving.Posting', $dataRcv->id) }}" class="form-horizontal" id="form_add" method="POST">
                {{ csrf_field() }}
                    <div class="card card-custom">
                        <div class="card-header bg-primary header-elements-sm-inline">
                            <h5 class="card-title text-white">Detail Penerimaan</h5>
                        </div>
                                    ...
                                    <div class="card mb-5">
                                        <div class="card-body">
                                            <div class="pb-5 fs-6">
                                                ...
                                                <div class="font-size-h5 font-weight-bolder mt-5">No. Purchase Order :</div>
                                                <div class="font-size-h6 text-dark-50">{{strtoupper($dataRcv->no_po)}}</div>
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            ...
                            <div class="mt-2 mt-sm-0">
                                ...
                                @if($dataRcv->status_penerimaan == "draft")
                                    ...
                                    <button type="button" class="btn btn-secondary mt-2 mt-sm-0 btnSubmit" id="btn_edit_staging" value="ubah alokasi barang">Ubah Alokasi Penerimaan<i class="flaticon2-box ml-2"></i></button>
                                ...
                                @elseif($dataRcv->status_penerimaan == "posted")
                                    @if($hakAkses->approve == "Y")
                                    ...
                                    @endif
                                    @if($hakAkses->print == "Y")
                                        <a type="button" class="btn btn-primary mt-2 mt-sm-0" href='{{route('Receiving.Cetak', $dataRcv->id)}}' target="_blank">Cetak<i class="fas fa-print ml-2"></i></a>
                                    @endif
                                @endif
                            </div>
                        </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(".btnSubmit").on("click", function(e){
            ...
            Swal.fire({
                title: ucwords(btn) + " Penerimaan Barang?",
                text: "Apakah yakin ingin melakukan " + ucwords(btn) +" Penerimaan Barang?",
                icon: "warning",
                showCancelButton: true,
                confirmButtonText: "Ya",
                cancelButtonText: "Tidak",
