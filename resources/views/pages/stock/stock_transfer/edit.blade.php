			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Ubah Pemindahan Stok Barang</h6>
					</div>
                    <form action="{{ route('StockTransfer.update', $dataTransfer->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-12 col-form-label">Kode Transaksi :</label>
                                            <div class="col-lg-12">
                                                <input type="hidden" class="form-control" id="mode" value="load" readonly>
                                                <input type="text" class="form-control bg-slate-600 border-slate-600 border-1" placeholder="Auto Generated" name="kode_trf" id="kode_trf" value="{{strtoupper($dataTransfer->kode_transaksi)}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <textarea class="form-control" id="keterangan" name="keterangan" rows="3" placeholder="Ketik Keterangan Disini">{{$dataTransfer->keterangan}}</textarea>
                                                    </div>
                                                </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#tanggal_picker").datepicker("setDate", new Date("{{$dataTransfer->tgl_transaksi}}"));
        });
