...
@section('content')
	<!-- Content area -->
			...
			@include('pages.alerts')
                ...
                <form action="{{ route('OutstandingSO.Export') }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
				<div class="card card-custom">
					<div class="card-header bg-primary header-elements-sm-inline">
                        <div class="card-title">
                            <h3 class="card-label text-white">Outstanding Sales Order</h3>
                        </div>
                        <div class="card-toolbar">
                            ...
                            @if($hakAkses->export == "Y")
                                    ...
                                    {{ csrf_field() }}
                                    <button type="button" class="btn btn-success font-weight-bold mr-2" id="btnExport" >Export Outstanding SO <i class="fas fa-file-excel"></i></button>
					...
					<div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-3 my-2 my-md-0">
                                            <div class="align-items-center">
                                                ...
                                                <div class="input-icon">
                                                    <input type="text" class="form-control" placeholder="Search..." id="table_outs_so_search_query"/>
                                                    <span>
                                        ...
                                        <div class="col-md-4 my-2 my-md-0">
                                            <div class="align-items-center">
                                                ...
                                                <select class="form-control select2" id="table_outs_so_search_customer" name="id_customer">
                        ...
                        <div class="datatable datatable-bordered datatable-head-custom" id="table_outs_so"></div>
...
@section('scripts')
	<script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#table_outs_so_search_customer').select2({
                allowClear: true,
		...
		$(document).ready(function() {
            ...
            var datatable = $('#table_outs_so').KTDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
                            url: '/OutstandingSO/GetDataOutstandingSO',
                            method: 'GET',
                ...
                search: {
                    input: $('#table_outs_so_search_query')
                },
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            var txt = "";
                                txt += "<a class='text-secondary text-hover-primary' href='{{route('SalesOrder.Detail', 'idSo')}}' target='_blank'>";
                                txt += '<span class="font-weight-bold">'+row.no_so.toUpperCase()+'</span>';
                                txt += "</a>";
                                txt += "<br />";
                                txt += '<span class="label label-md label-outline-primary label-inline mt-1">' + row.nama_customer + '</span>';
                                txt = txt.replaceAll('idSo',row.id);
                                return txt;
                        },
                    },
                    {
            ...
            $('#table_outs_so_search_customer').on('change', function() {
