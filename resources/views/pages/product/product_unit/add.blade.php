			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h5 class="card-title text-white">Tambah Satuan</h5>
					</div>
                    <form action="{{ route('ProductUnit.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Kode Satuan" id="kode_satuan" name="kode_satuan" class="form-control req" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Nama Satuan" id="nama_satuan" name="nama_satuan" class="form-control req">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Keterangan Satuan" id="keterangan_satuan" name="keterangan_satuan" class="form-control req">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Kode Satuan untuk FP" id="kode_satuan_pajak" name="kode_satuan_pajak" class="form-control">
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-light-danger font-weight-bold mr-2" onclick="window.location.href = '{{ url('/ProductUnit') }}';">Keluar <i class="flaticon2-cancel icon-sm"></i></button>
                            </div>
