	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom card-sticky">
                    ...
                    <form action="{{ route('ProductBrand.update', $dataBrand->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                            <input type="text" placeholder="Masukkan Nama Merk" id="nama_merk" name="nama_merk" class="form-control req" value="{{$dataBrand->nama_merk}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Keterangan Merk" id="keterangan_merk" name="keterangan_merk" class="form-control req" value="{{$dataBrand->keterangan_merk}}">
    ...
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '{{ url("/ProductBrand") }}';
                    // Swal.fire(
                    //     "Deleted!",
