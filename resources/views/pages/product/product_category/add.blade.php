	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom card-sticky">
                    ...
                    <form action="{{ route('ProductCategory.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Kode Kategori untuk Faktur Pajak" id="kode_kategori_pajak" name="kode_kategori_pajak" class="form-control">
                                                <span class="form-text text-danger err" style="display:none;">*Harap Masukkan Nama Kategori terlebih dahulu!</span>
                                            </div>
                                        </div>
                                    </fieldset>
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-light-danger font-weight-bold mr-2" onclick="window.location.href = '{{ url('/ProductCategory') }}';">Keluar <i class="flaticon2-cancel icon-sm"></i></button>
                            </div>
