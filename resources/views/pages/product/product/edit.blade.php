	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom">
					...
					<div class="card-body">
						<form action="{{ route('Product.update', $dataProduct->id) }}" method="POST" id="form_add" enctype="multipart/form-data" autocomplete="off">
						{{ csrf_field() }}
                        @method('PUT')
									...
									<div class="col-md-6">
										<fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control" value="{{ucwords($dataCategory->kode_kategori)}} - {{ucwords($dataCategory->nama_kategori)}}" readonly>
                                                </div>
                                            </div>
									...
									<div class="col-md-6">
										<fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control req" placeholder="Masukkan Nama Barang" name="nama_item" id="nama_item" value="{{$dataProduct->nama_item}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea class="form-control" name="keterangan_item_txt" id="keterangan_item_txt" style="resize:none;">{{$dataProduct->keterangan_item}}</textarea>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-outline" id="image_product">
                                            ...
                                            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Ubah Gambar">
...
@section('scripts')
    <script type="text/javascript">
		...
		$("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan perubahan data Barang?",
                icon: "warning",
			...
			$(".stok").change(function(){
			    if($(this).val() < 0){
			      ...
			      $(this).val(0);
                    ...
                    if (parseInt($("#stok_minimum").val()) > parseInt($("#stok_maksimum").val())) {
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            ...
                            var datatable = $('#list_cust').KTDatatable();
                                datatable.setDataSourceParam('id', '{{$dataProduct->id}}');
