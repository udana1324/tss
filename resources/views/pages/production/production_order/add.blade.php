			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Buat Perintah Produksi Baru</h6>
					</div>
                    <form action="{{ route('ProductionOrder.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group row d-none">
                                            <label class="col-lg-3 col-form-label">Kode Perintah Produksi :</label>
                                            <div class="col-lg-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group  form-group-feedback form-group-feedback-right divTgl">
                                                ...
                                                <input type="text" class="form-control pickerTgl" placeholder="Pilih Tanggal Perintah Produksi" name="tanggal_picker" id="tanggal_picker" readonly>
                                                <span class="form-text text-danger err" style="display:none;">*Harap pilih tanggal produksi terlebih dahulu!</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-gutters">
                                                <div class="radio-inline">
                                                    <label class="radio">
                                                    <input type="radio" id="jenisInternal" name="flag_internal" checked value="1" />
                                                    <span></span>Internal</label>
                                                    <label class="radio">
                                                    <input type="radio" id="jenisEksternal" name="flag_internal" value="0" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <textarea class="form-control elastic" id="tnc" name="tnc" rows="3" placeholder="Ketik Syarat & Ketentuan Disini atau gunakan Template pada tombol Template"></textarea>
                                                    <div class="input-group-append">
								...
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        {{-- <div class="form-group row mb-0" id="divMaklun1">
										...
										<div class="form-group" id="divMaklun2">
											...
											<span class="form-text text-danger errItemPrice" style="display:none;">*Biaya tidak dapat dibawah 0!</span>
                                            <span class="form-text text-danger errItemReq" style="display:none;">*Harap masukkan biaya terlebih dahulu!</span>
										</div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset>
                                        <legend class="text-muted"><h6><i class="la la-list"></i> Rincian Bahan Baku</h6></legend>
                                        <div class="separator separator-solid separator-border-2 separator-muted"></div>
                                        <br>
								    ...
								    <table class="table display" id="list_edit_item" width="100%">
									    <thead>
										    <tr>
											    ...
											    <th align="center" style="text-align:center;" class="hargaMaklun">Harga Beli</th>
										    </tr>
									    </thead>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#product').select2({
                allowClear: true,
                placeholder: "Klik untuk pilih barang yang akan dikirim untuk diproduksi..."
            });
        ...
        $(".pickerTgl").on('change', function() {
            ...
            if ($("#tanggal_req").val() != "") {
                if (reqDate < poDate) {
                    Swal.fire(
                        "Error!",
                        "Tanggal Request tidak boleh dibawah dari tanggal Perintah Produksi!.",
                        "warning"
                    )
                    $("#tanggal_req").val("");
            ...
            if ($("#tanggal_deadline").val() != "") {
                if (deadLineDate < reqDate) {
                    Swal.fire(
                        "Error!",
                        "Tanggal Deadline tidak boleh dibawah dari tanggal Request dan Perintah Produksi!.",
                        "warning"
                    )
                    $("#tanggal_deadline_picker").val("");
                    $("#tanggal_deadline").val("");
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan pembuatan perintah produksi?",
                icon: "warning",
        ...
        $("#supplier").on("change", function() {
            ...
            $.ajax({
                ...
                success: function(result){
                    var datatable = $('#list_item').KTDatatable();
                        datatable.setDataSourceParam('idProductionOrder', '');
                        datatable.reload();
        ...
        function getSupplierTaxPayment(idSupplier) {
            ...
            $.ajax({
                url: "/ProductionOrder/GetSupplierPreviousOrder",
                method: 'POST',
                data: {
                    id_supplier: idSupplier,
                },
                        ...
                        $.ajax({
                            ...
                            success: function(result){
                                if (result == "success") {
                                    ...
                                    Swal.fire(
                                        "Gagal!",
                                        "Item ini sudah tersedia pada Rincian !",
                                        "warning"
                                    )
                                }
                            }
            ...
            $.ajax({
                ...
                success: function(result){
                    if (result.length > 0) {
                        ...
                        var hargaBeli = parseFloat(result[0].harga);
                        ...
                        var data = "<tr>";
                            ...
                            data += "<td width='150px' style='text-align:center;'><input type='hidden' class='form-control priceValEdit' onkeypress='return validasiDecimal(this,event);' id='hargaBaru' value='"+hargaBeliFixed+"' /></td>";
                            data += "</tr>";
