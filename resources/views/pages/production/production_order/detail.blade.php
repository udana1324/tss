			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary text-white header-elements-sm-inline">
						<h5 class="card-title text-white">Detail Perintah Produksi</h5>
					</div>
                    <form action="{{ route('ProductionOrder.Posting', $dataProductionOrder->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
                                        <legend class="text-muted"><h6><i class="la la-clipboard-list"></i> Informasi Pabrik / Vendor </h6></legend>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control bg-slate-600 border-slate-600 border-1" placeholder="Auto Generated" name="kode_item" id="kode_item" value="{{strtoupper($dataProductionOrder->no_production_order)}}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row d-none">
                                            <label class="col-lg-3 col-form-label">No. PO Produksi :</label>
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control " placeholder="Auto Generated" name="po_production" id="po_production" value="{{$dataProductionOrder->po_production}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <input type="text" class="form-control req" name="tanggal" id="tanggal" value="{{\Carbon\Carbon::parse($dataProductionOrder->tanggal)->format('d F Y')}}"  readonly>
                                                <span class="form-text text-danger err" style="display:none;">*Harap pilih tanggal pembelian terlebih dahulu!</span>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label>Permintaan Penerimaan Hasil Produksi :</label>
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <input type="text" class="form-control req" name="tanggal_req" id="tanggal_req" value="{{\Carbon\Carbon::parse($dataProductionOrder->tanggal_request)->format('d F Y')}}" readonly>
                                                <span class="form-text text-danger err" style="display:none;">*Harap pilih tanggal pembelian terlebih dahulu!</span>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label>Batas Waktu Penerimaan Hasil Produksi :</label>
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <input type="text" class="form-control req" name="tanggal_deadline" id="tanggal_deadline" value="{{\Carbon\Carbon::parse($dataProductionOrder->tanggal_deadline)->format('d F Y')}}" readonly>
                                                <span class="form-text text-danger err" style="display:none;">*Harap pilih tanggal pembelian terlebih dahulu!</span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="cash" disabled="disabled" value="cash" name="metode_bayar" {{ $dataProductionOrder->metode_pembayaran === "cash" ? "checked" : "" }} readonly />
                                                            <span></span>Cash/Tunai
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" id="credit" disabled="disabled" value="credit" name="metode_bayar" {{ $dataProductionOrder->metode_pembayaran === "credit" ? "checked" : "" }} readonly />
                                                            <span></span>Kredit
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6" id="durasiJT" @if ($dataProductionOrder->metode_pembayaran == "cash") style="display:none;" @endif>
    											<label>Durasi (Hari) :</label>
    											<div>
    												<input type="text" class="form-control" maxlength="4" onkeypress="return validasiAngka(event);" name="durasi_jt" id="durasi_jt" value="{{$dataProductionOrder->durasi_jt}}" readonly>
    											</div>
    										</div>
                                        </div> --}}
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="no-gutters">
                                                <div class="radio-inline">
                                                    <label class="radio">
                                                    <input type="radio" id="statPpn_y" disabled="disabled" name="status_ppn" value="Y" {{ $dataProductionOrder->flag_ppn === "Y" ? "checked" : "" }} readonly />
                                                    <span></span>PPn Excl.</label>
                                                    <label class="radio">
                                                    <input type="radio" id="statPpn_i" disabled="disabled" name="status_ppn" value="I" {{ $dataProductionOrder->flag_ppn === "I" ? "checked" : "" }} readonly />
                                                    <span></span>PPn Incl.</label>
                                                    <label class="radio">
                                                    <input type="radio" id="statPpn_n" disabled="disabled" name="status_ppn" value="N" {{ $dataProductionOrder->flag_ppn === "N" ? "checked" : "" }} readonly />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="percentage" disabled="disabled" value="P" name="jenis_diskon" {{ $dataProductionOrder->jenis_diskon === "P" ? "checked" : "" }} />
                                                            <span></span>Persentase
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" id="nominal" disabled="disabled" value="N" name="jenis_diskon" {{ $dataProductionOrder->jenis_diskon === "N" ? "checked" : "" }} />
                                                            <span></span>Nominal
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6" id="discPercent" @if ($dataProductionOrder->jenis_diskon == "N") style="display:none;" @endif>
    											<label id="txtDiskonP">Persentase (%):</label>
    											<div>
    												<input type="text" class="form-control discount" onkeypress="return validasiAngka(event);" name="disc_percent" id="disc_percent" value="{{$dataProductionOrder->persentase_diskon}}" readonly>
                                                </div>
    										</div>
                                            <div class="col-lg-6" id="discNominal" @if ($dataProductionOrder->jenis_diskon == "P") style="display:none;" @endif>
    											<label id="txtDiskonN">Nominal (Rp) :</label>
    											<div>
    												<input type="text" class="form-control discount" onkeypress="return validasiAngka(event);" name="disc_nominal" id="disc_nominal" value="{{$dataProductionOrder->nominal_diskon}}" readonly>
                                                </div>
    										</div>
    									</div> --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-gutters">
                                                <div class="radio-inline">
                                                    <label class="radio">
                                                    <input type="radio" id="jenisInternal" name="flag_internal" disabled="disabled" value="1" {{ $dataProductionOrder->flag_internal == "1" ? "checked" : "" }} />
                                                    <span></span>Internal</label>
                                                    <label class="radio">
                                                    <input type="radio" id="jenisEksternal" name="flag_internal" disabled="disabled" value="0" {{ $dataProductionOrder->flag_internal == "0" ? "checked" : "" }} />
                                                    <span></span>Maklun</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <textarea class="form-control elastic" id="tnc" name="tnc" rows="4" placeholder="Ketik Syarat & Ketentuan Disini" readonly>@foreach($dataTerms as $terms){{$terms->terms_and_cond}}@endforeach</textarea>
                                                    <div class="input-group-append">
								...
								<div class="col-md-6">
									<fieldset>
					                	<legend class="text-muted"><h6><i class="fab la-buffer"></i> Rincian Perintah Produksi</h6></legend>
                                        <div class="separator separator-solid separator-border-2 separator-muted"></div>
                                        <br>
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" onkeypress="return validasiDecimal(this,event);" name="dp" id="dp" value="{{ $dataProductionOrder->status === "draft" ? $dataProductionOrder->nominal_dp : number_format($dataProductionOrder->nominal_dp, 0, ',', '.') }}" {{ $dataProductionOrder->status === "draft" ? "" : "readonly" }}>
                                                    <div class="input-group-append" style="display: {{ $dataProductionOrder->status === 'draft' ? 'block' : 'none' }};">
                                        ...
                                        {{-- <div class="form-group" style="display: {{ $dataProductionOrder->status === 'draft' ? 'none' : 'block' }};">
                                            <label>Sisa Down Payment :</label>
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" onkeypress="return validasiDecimal(this,event);" name="sisaDp" id="sisaDp" value="{{number_format($dataProductionOrder->sisa_dp, 0, ',', '.')}}" {{ $dataProductionOrder->status === "draft" ? "" : "readonly" }}>
                                                </div>
                                            </div>
                                        </div> --}}

										<div class="form-group">
                                            <label>Status Perintah Produksi :</label>
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="status" id="status" value="{{strtoupper($dataProductionOrder->status)}}" readonly>
                                                </div>
                                            </div>
                                        </div>

										<div class="form-group">
											<label>Status Revisi Perintah Produksi :</label>
											<div class="input-group">
        										<div class="col-12 pl-0">
        											<input type="text" id="revisi" class="form-control" value="{{ $dataProductionOrder->flag_revisi == "1" ? "Revisi" : "Tidak" }}" readonly>
        										</div>
											</div>
										</div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset>
                                        <legend class="text-muted"><h6><i class="la la-clipboard-list"></i> Rincian Bahan Baku Produksi </h6></legend>
                                        <div class="separator separator-solid separator-border-2 separator-muted"></div>
                                        <br>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Total Barang</label>
										<div class="col-lg-9">
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            ...
                            <div class="mt-2 mt-sm-0">
                                ...
                                @if($dataProductionOrder->status == "draft")
                                    <button type="button" class="btn btn-secondary mt-2 mt-sm-0 btnSubmit" id="btn_edit" value="ubah">Ubah Perintah Produksi<i class="flaticon-edit ml-2"></i></button>
                                ...
                                @elseif($dataProductionOrder->status == "posted")
                                    @if($hakAkses->approve == "Y")
                                        @if($rcvCount == 0)
                                ...
                                @endif
                                @if($hakAkses->print == "Y")
									<a type="button" class="btn btn-primary mt-2 mt-sm-0" href='{{route('ProductionOrder.Cetak', $dataProductionOrder->id)}}' target="_blank">Cetak<i class="fas fa-print ml-2"></i></a>
								@endif
                            </div>
                        </div>
                    </form>
    ...
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                ...
                if(result.value) {
                    window.location.href = "{{ url('/ProductionOrder') }}";
                }
        ...
        $(".btnSubmit").on("click", function(e){
            ...
            Swal.fire({
                title: ucwords(btn) + " Perintah Produksi?",
                text: "Apakah yakin ingin melakukan " + ucwords(btn) +" Perintah Produksi?",
                icon: "warning",
                showCancelButton: true,
                confirmButtonText: "Ya",
                cancelButtonText: "Tidak",
        ...
        $("#supplier").on("change", function() {
            ...
            $.ajax({
                url: "/ProductionOrder/GetDefaultAddress",
                method: 'POST',
                data: {
                    id_alamat: "{{$dataProductionOrder->id_alamat}}",
                },
            ...
            $.ajax({
                url: "/ProductionOrder/GetSupplierAddress",
                method: 'POST',
                data: {
        ...
        $("#product").on("change", function() {
            ...
            $.ajax({
                url: "/ProductionOrder/GetDataItem",
                method: 'POST',
                data: {
                    id_product: $(this).val(),
                },
        ...
        function getSupplierProduct(idSupplier) {
            ...
            $.ajax({
                url: "/ProductionOrder/GetProductBySupplier",
                method: 'POST',
                data: {
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_item').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/ProductionOrder/GetDetail',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
                            data : {
                                idProductionOrder : '{{$dataProductionOrder->id}}'
                            },
                        }
                    },
                    pageSize: 100,
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            ...
                            // if (jenisPPn == "I") {
                            //     var hargaMask = parseFloat(row.harga) / parseFloat(persenPPNInclude);
                            // }
                            // else {
                            //     var hargaMask = parseFloat(row.harga);
                            // }
                            var hargaMask = parseFloat(row.harga);
        ...
        function footerDataForm(idPo) {
            ...
            $.ajax({
                url: "/ProductionOrder/GetDataFooter",
                method: 'POST',
                data: {
                    idPo: idPo,
                },
                success: function(result){
                    if (result != "") {
                        ...
                        var jenisPPn = $('input[name=status_ppn]:checked').val();
                        var jenisDisc = "{{$dataProductionOrder->jenis_diskon}}";
                        ...
                        if(jenisDisc == "P") {
                            persenDiskon = "{{$dataProductionOrder->persentase_diskon}}";
                            diskonNominal = parseFloat(subtotalFixed) * (parseFloat(persenDiskon) / 100);
                        }
                        else if(jenisDisc == "N") {
                            diskonNominal = "{{$dataProductionOrder->nominal_diskon}}";
                        }
        ...
        $("#persen_diskon").on("change", function() {
            footerDataForm('{{$dataProductionOrder->id}}');
        });

        $(document).ready(function () {
            $("#supplier").val("{{$dataProductionOrder->id_supplier}}").trigger('change');
            footerDataForm('{{$dataProductionOrder->id}}');
        });
