			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary text-white header-elements-sm-inline">
						<h5 class="card-title text-white">Ubah Perintah Produksi</h5>
					</div>
                    <form action="{{ route('ProductionOrder.update', $dataProductionOrder->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control bg-slate-600 border-slate-600 border-1" placeholder="Auto Generated" name="kode_item" id="kode_item" value="{{strtoupper($dataProductionOrder->no_production_order)}}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row d-none">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control " placeholder="Auto Generated" name="po_production" id="po_production">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group divTgl form-group-feedback form-group-feedback-right">
                                                <input type="hidden" class="form-control tglValue req" name="tanggal" id="tanggal">
                                                <input type="text" class="form-control pickerTgl" placeholder="Pilih Tanggal" name="tanggal_picker" id="tanggal_picker" readonly>
                                                <span class="form-text text-danger err" style="display:none;">*Harap pilih tanggal perintah produksi terlebih dahulu!</span>
                                            </div>
                                        </div>
                                        ...
                                        {{-- <div class="form-group row">
                                            <div class="col-lg-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="cash" value="cash" name="metode_bayar" {{ $dataProductionOrder->metode_pembayaran === "cash" ? "checked" : "" }} />
                                                            <span></span>Cash/Tunai
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" id="credit" value="credit" name="metode_bayar" {{ $dataProductionOrder->metode_pembayaran === "credit" ? "checked" : "" }} />
                                                            <span></span>Kredit
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6" id="durasiJT" @if ($dataProductionOrder->metode_pembayaran == "cash") style="display:none;" @endif>
    											...
    											<div>
    												<input type="text" class="form-control" maxlength="4" onkeypress="return validasiAngka(event);" name="durasi_jt" id="durasi_jt" value="{{$dataProductionOrder->durasi_jt}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-gutters">
                                                <div class="radio-inline">
                                                    <label class="radio">
                                                    <input type="radio" id="statPpn_y" name="status_ppn" value="Y" {{ $dataProductionOrder->flag_ppn === "Y" ? "checked" : "" }} />
                                                    <span></span>PPn Excl.</label>
                                                    <label class="radio">
                                                    <input type="radio" id="statPpn_i" name="status_ppn" value="I" {{ $dataProductionOrder->flag_ppn === "I" ? "checked" : "" }} />
                                                    <span></span>PPn Incl.</label>
                                                    <label class="radio">
                                                    <input type="radio" id="statPpn_n" name="status_ppn" value="N" {{ $dataProductionOrder->flag_ppn === "N" ? "checked" : "" }} />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="percentage" value="P" name="jenis_diskon" {{ $dataProductionOrder->jenis_diskon === "P" ? "checked" : "" }} />
                                                            <span></span>Persentase
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" id="nominal" value="N" name="jenis_diskon" {{ $dataProductionOrder->jenis_diskon === "N" ? "checked" : "" }} />
                                                            <span></span>Nominal
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6" id="discPercent" @if ($dataProductionOrder->jenis_diskon == "N") style="display:none;" @endif>
    											...
    											<div>
    												<input type="text" class="form-control discount" onkeypress="return validasiAngka(event);" name="disc_percent" id="disc_percent" value="{{$dataProductionOrder->persentase_diskon}}">
                                                </div>
    										</div>
                                            <div class="col-lg-6" id="discNominal" @if ($dataProductionOrder->jenis_diskon == "P") style="display:none;" @endif>
    											...
    											<div>
    												<input type="text" class="form-control discount" onkeypress="return validasiAngka(event);" name="disc_nominal" id="disc_nominal" value="{{$dataProductionOrder->nominal_diskon}}">
                                                </div>
    										</div>
    									</div> --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-gutters">
                                                <div class="radio-inline">
                                                    <label class="radio">
                                                    <input type="radio" id="jenisInternal" name="flag_internal" value="1" {{ $dataProductionOrder->flag_internal == "1" ? "checked" : "" }} />
                                                    <span></span>Internal</label>
                                                    <label class="radio">
                                                    <input type="radio" id="jenisEksternal" name="flag_internal" value="0" {{ $dataProductionOrder->flag_internal == "0" ? "checked" : "" }} />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <textarea class="form-control elastic" id="tnc" name="tnc" rows="3" placeholder="Ketik Syarat & Ketentuan Disini atau gunakan Template pada tombol Template">@foreach($dataTerms as $terms){{$terms->terms_and_cond}}@endforeach</textarea>
                                                    <div class="input-group-append">
								...
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group">
											<label class="font-weight-semibold">Biaya Jasa :</label>
											<input type="text" id="harga_beli_mask" autocomplete="off" data-a-dec="," data-a-sep="." class="form-control text-right">
											<input type="hidden" id="harga_beli" min="0" class="form-control text-right priceVal" autocomplete="off">
                                            <span class="form-text text-danger errItemPrice" style="display:none;">*Harga Barang tidak dapat dibawah 0!</span>
                                            <span class="form-text text-danger errItemReq" style="display:none;">*Harap masukkan harga beli item terlebih dahulu!</span>
										</div>
				...
				<div id="modal_form_edit_item" class="modal fade">
				    <div class="modal-dialog modal-lg">
					    <div class="modal-content">
						    <div class="modal-header bg-primary">
							    <h5 class="modal-title text-white">Ubah Detail Item</h5>
						    </div>
						    <div class="modal-body">
							    <form >
							        <div class="row">
                                        <div class="col-md-12">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label class="font-weight-semibold">Biaya :</label>
                                                    <input type="text" id="hargaBaruMask" autocomplete="off" data-a-dec="," data-a-sep="." class="form-control text-right">
                                                    <input type="hidden" id="hargaBaru" min="0" class="form-control text-right priceValEdit" autocomplete="off">
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#tanggal_picker, #tanggal_req_picker, #tanggal_deadline_picker').datepicker({
                rtl: KTUtil.isRTL(),
                todayHighlight: true,
        ...
        $(".pickerTgl").on('change', function() {
            ...
            var poDate = new Date($("#tanggal_picker").data('datepicker').getFormattedDate('yyyy-mm-dd'));
            ...
            if ($("#tanggal_req").val() != "") {
                if (reqDate < poDate) {
                    Swal.fire(
                        "Error!",
                        "Tanggal Permintaan tidak boleh dibawah dari tanggal Perintah Produksi!.",
                        "warning"
                    )
                    $("#tanggal_req").val("");
            ...
            if ($("#tanggal_deadline").val() != "") {
                if (deadLineDate < reqDate) {
                    Swal.fire(
                        "Error!",
                        "Tanggal Deadline tidak boleh dibawah dari tanggal Permintaan dan Perintah Produksi!.",
                        "warning"
                    )
                    $("#tanggal_deadline_picker").val("");
                    $("#tanggal_deadline").val("");
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan perubahan perintah produksi?",
                icon: "warning",
                ...
                if(result.value) {
                    ...
                    $.ajax({
                        url: "/ProductionOrder/RestoreDetail",
                        method: 'POST',
                        data: {
                           idPo: '{{$dataProductionOrder->id}}'
                        },
            ...
            Swal.fire({
                ...
                if(result.value) {
                    ...
                    if(parseInt(dataCount) < 1) {
                        Swal.fire(
                            "Gagal!",
                            "Harap Tambahkan Minimum 1 Item!.",
                            "warning"
                        )
                        count = parseInt(count) + 1;
                    }
        ...
        $("#supplier").on("change", function() {
            ...
            if ($("#mode").val() == "edit") {
                ...
                $.ajax({
                    url: "/ProductionOrder/ResetDetail",
                    method: 'POST',
                    data: {
                        idPO: '{{$dataProductionOrder->id}}',
                    },
                    success: function(result){
                        var datatable = $('#list_item').KTDatatable();
                            datatable.setDataSourceParam('idProductionOrder', '{{$dataProductionOrder->id}}');
        ...
        $("#list_product").on('click', 'table .addToList', function() {
            ...
            Swal.fire({
                ...
                if(result.value) {
                    ...
                    $.ajax({
                        url: "/ProductionOrder/AddSupllierProduct",
                        method: 'POST',
                        data: {
                            id_item: idItem,
                            id_supplier: idSupp
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_product').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/ProductionOrder/GetProduct',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_riwayat').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/ProductionOrder/GetProductHistory',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
        ...
        $("#btnAddItem").on('click', function(e) {
            ...
            if ($('input[name=flag_internal]:checked').val() == "0") {
                $(".priceVal").each(function() {
                    if($(this).val() == "") {
                        $(this).closest('.form-group, input-group').find('.errItemReq').show();
                        errCount = errCount + 1;
                    }
                        ...
                        $(this).closest('.form-group, input-group').find('.errItemReq').hide();
                    }
                });
            }
			...
			if (errCount == 0) {
                Swal.fire({
                    ...
                    if(result.value) {
                        ...
                        $.ajax({
                            url: "/ProductionOrder/StoreDetail",
                            method: 'POST',
                            dataType : 'json',
                            data: {
                            ...
                            success: function(result){
                                if (result == "success") {
                                    ...
                                    Swal.fire(
                                        "Gagal!",
                                        "Item ini sudah tersedia pada List Perintah Produksi !",
                                        "warning"
                                    )
                                }
                            }
        ...
        function editDetailItem(id) {
            ...
            $.ajax({
                url: "/ProductionOrder/EditDetail",
                method: 'POST',
                data: {
                    idDetail: id,
                    mode:'edit'
        ...
        function deleteDetailItem(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "/ProductionOrder/DeleteDetail",
                        method: 'POST',
                        data: {
                            idDetail: id,
                            mode: "edit"
	    ...
	    $(document).on("click", "#btnEditItem", function(e) {
            ...
            if(errVal != 0) {
                ...
                Swal.fire(
                    "Gagal!",
                    "Biaya tidak dapat kurang dari 0 !",
                    "warning"
                )
            }
                ...
                Swal.fire({
                    ...
                    if(result.value) {
                        ...
                        $.ajax({
                            url: "/ProductionOrder/UpdateDetail",
                            method: 'POST',
                            dataType : 'json',
                            data: {
                                idItem : idItem,
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: "/ProductionOrder/GetListTerms",
                method: 'POST',
                data: {
                    target: "pembelian",
                },
        ...
        $(document).ready(function () {
            ...
            $("#tanggal_picker").datepicker("setDate", new Date("{{$dataProductionOrder->tanggal}}"));
            $("#tanggal_req_picker").datepicker("setDate", new Date("{{$dataProductionOrder->tanggal_request}}"));
            $("#tanggal_deadline_picker").datepicker("setDate", new Date("{{$dataProductionOrder->tanggal_deadline}}"));
            footerDataForm('{{$dataProductionOrder->id}}');
            $("#mode").val("edit");
        });
