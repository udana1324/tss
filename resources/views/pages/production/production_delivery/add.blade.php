			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h5 class="card-title text-white">Buat Pengiriman Bahan Produksi</h5>
					</div>
                    <form action="{{ route('ProductionDelivery.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group row d-none">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control bg-slate-600 border-slate-600 border-1" placeholder="Auto Generated" name="kode_pengiriman" id="kode_pengiriman" readonly>
                                            </div>
                                        </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#tanggal_sj_picker").datepicker('setDate', new Date());
        });
        ...
        $("#supplier").on("change", function() {
            ...
            $.ajax({
                ...
                success: function(result){
                    var datatable = $('#list_item').KTDatatable();
                        datatable.setDataSourceParam('idProductionDelivery', '');
                        datatable.reload();
