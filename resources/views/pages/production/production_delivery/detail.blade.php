...
@section('content')
	...
	@include('pages.alerts')
			<div class="content">
                <form action="{{ route('ProductionDelivery.Posting', $dataDlv->id) }}" class="form-horizontal" id="form_add" method="POST">
                {{ csrf_field() }}
                    <div class="card card-custom">
                        <div class="card-header bg-primary header-elements-sm-inline">
                            <h5 class="card-title text-white">Detail Pengiriman Barang Produksi</h5>
                        </div>
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            ...
                            <div class="mt-2 mt-sm-0">
                                ...
                                @elseif($dataDlv->status_pengiriman == "posted")
                                    ...
                                    @endif
                                    @if($hakAkses->print == "Y")
                                        <a type="button" class="btn btn-primary mt-2 mt-sm-0" href='{{route('ProductionDelivery.Cetak', $dataDlv->id)}}' target="_blank">Cetak<i class="fas fa-print ml-2"></i></a>
                                    @endif
                                @endif
                            </div>
                        </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(".btnSubmit").on("click", function(e){
            ...
            // if (parseFloat(totalAlokasi) != parseFloat(ttlPenerimaan)) {
            //     Swal.fire(
            //         "Gagal!",
