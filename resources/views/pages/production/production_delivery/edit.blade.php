			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h5 class="card-title text-white">Ubah Pengiriman Bahan Produksi</h5>
					</div>
                    <form action="{{ route('ProductionDelivery.update', $dataDlv->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
									...
									<fieldset>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text" class="form-control bg-slate-600 border-slate-600 border-1" placeholder="Auto Generated" name="kode_pengiriman" id="kode_pengiriman" value="{{strtoupper($dataDlv->kode_pengiriman)}}" readonly>
                                            </div>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="hidden" class=" form-control req" name="id_alamat" id="id_alamat" value="{{$dataDlv->id_alamat}}">
                                                    <textarea class="form-control" name="alamat" id="alamat" style="resize:none;" placeholder="Silahkan Klik Tombol Pilih Alamat" readonly>value="{{$dataDlv->alamat_supplier}}"</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <input type="hidden" class="form-control" name="tanggal_sj" id="tanggal_sj">
                                                <input type="text" class="form-control" name="tanggal_sj_picker" id="tanggal_sj_picker" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="divTnc">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <textarea class="form-control elastic" id="tnc" name="tnc" rows="3" placeholder="Ketik Syarat & Ketentuan Pengiriman Disini atau gunakan Template pada tombol Template"></textarea>
                                                    <div class="input-group-append">
								...
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="col-12 pl-0">
                                                        <input type="text" id="qtyStockMask" autocomplete="off" data-a-dec="," data-a-sep="." class="form-control text-right" readonly>
                                                        <input type="hidden" id="qtyStock" class="form-control text-right">
                                                    </div>
                                                    {{-- <div class="col-4">
                                            ...
                                            <div class="col-6">
                                                <label>Jumlah Pengiriman Barang :</label>
                                                <div class="input-group">
                                                    <div class="col-12 pr-0 pl-0">
                                                        ...
                                                        <span class="form-text text-danger errItem" style="display:none;">*Harap masukkan Jumlah pengiriman terlebih dahulu!</span>
                                                    </div>
                                                    <div class="col-4">
				    ...
				    <div class="modal-dialog modal-lg">
					    <div class="modal-content">
						    <div class="modal-header bg-primary">
							    ...
							    <h5 class="modal-title">Ubah Jumlah Pengiriman Item</h5>
						    </div>
						    <div class="modal-body">
							    <form >
								    <table class="table display" id="list_edit_item" width="100%">
									    <thead>
										    <tr>
                                                ...
                                                <th align="center" style="text-align:center;">Stok</th>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#qtyStockMask").autoNumeric('init');
            $("#supplier").val("{{$dataDlv->id_supplier}}").trigger("change");
            $("#tanggal_sj_picker").datepicker('setDate', new Date("{{$dataDlv->tanggal_sj}}"));
        ...
        $("#qtyStockMask").on('change', function() {
            $("#qtyStock").val($("#qtyStockMask").autoNumeric("get"));
        });
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan pembuatan pengiriman produksi?",
                icon: "warning",
                ...
                if(result.value) {
                    window.location.href = "{{ url('/ProductionDelivery') }}";
                }
            ...
            Swal.fire({
                ...
                if(result.value) {
                    ...
                    if(datatable.getTotalRows() < 1) {
                        Swal.fire(
                            "Gagal!",
                            "Harap Tambahkan Minimum 1 Item Pengiriman!.",
                            "warning"
                        )
                        count = parseInt(count) + 1;
        ...
        $("#supplier").on("change", function() {
            ...
            $.ajax({
                url: "/ProductionDelivery/GetSupplierAddress",
                method: 'POST',
                data: {
                    idSupplier: $(this).val(),
                },
                    ...
                    if (result.length > 0) {
                        ...
                        if (result.length > 0) {
                            for (var i = 0; i < result.length;i++) {
                                ...
                                var alamat = result[i].alamat_supplier;
            ...
            if ($(this).val() != "") {
                ...
                $.ajax({
                    url: "/ProductionDelivery/GetDefaultAddress",
                    method: 'POST',
                    data: {
                        idSupplier: $(this).val(),
                    },
                    success: function(result){
                        if (result.length > 0) {
                            ...
                            $("#alamat").val(ucwords(result[0].alamat_supplier));
                        }
                    }
                });
            }
            ...
            if ($("#mode").val() == "edit") {
                ...
                $.ajax({
                    url: "/ProductionDelivery/ResetDetail",
                    method: 'POST',
                    data: {
                        idDlv: '{{$dataDlv->id}}',
                    },
                    success: function(result){
                        var datatable = $('#list_item').KTDatatable();
                                datatable.setDataSourceParam('idProductionDelivery', '{{$dataDlv->id}}');
        ...
        $("#product").on("change", function() {
            ...
            $.ajax({
                url: "/ProductionDelivery/GetSatuan",
                method: 'POST',
                data: {
                    idProduct: $(this).val(),
                },
        ...
        $("#productUnit").on("change", function() {
            ...
            $.ajax({
                url: "/ProductionDelivery/GetDataItem",
                method: 'POST',
                data: {
                ...
                success: function(result){
                    if (result.length > 0) {
                        var stock = result[0].stok_item;
                        var stockFixed = stock.toString().replace(".", ",");
                        $("#qtyStockMask").val(stockFixed).trigger("change");
                    }
                    else {
                        $("#qtyStockMask").val("").trigger("change");
                    }
                }
            });
        ...
        function getProduct(idPo) {
            ...
            $.ajax({
                url: "/ProductionDelivery/GetProductBySupplier",
                method: 'POST',
                data: {
                    id_supplier: idPo,
                },
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_item').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/ProductionDelivery/GetDetail',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
        ...
        $("#btnAddItem").on('click', function(e) {
            ...
            var qty = parseFloat($("#qtyItem").val());
	     	var stock = parseFloat($("#qtyStock").val());
            ...
            if (parseFloat(qty) > parseFloat(stock)) {
                Swal.fire(
                    "Gagal!",
                    "Jumlah Item Tidak dapat melebihi jumlah stock !",
                    "warning"
                );
                return false;
            }
			...
			if (errCount == 0) {
                Swal.fire({
                    ...
                    if(result.value) {
                        ...
                        $.ajax({
                            url: "/ProductionDelivery/StoreDetail",
                            method: 'POST',
                            dataType : 'json',
                            data: {
                                ...
                                idProductionDelivery : "{{$dataDlv->id}}",
                                qtyItem : $("#qtyItem").val(),
                            },
                            success: function(result){
                                if (result == "success") {
                                    ...
                                    Swal.fire(
                                        "Gagal!",
                                        "Item ini sudah tersedia pada List Pengiriman Barang !",
                                        "warning"
                                    )
                                }
                            }
        ...
        function editDetailItem(id) {
            ...
            $.ajax({
                url: "/ProductionDelivery/EditDetail",
                method: 'POST',
                data: {
                    idDetail: id,
                    mode: 'edit'
                ...
                success: function(result){
                    if (result.length > 0) {
                        ...
                        var data = "<tr>";
                            ...
                            data += "<td style='text-align:center;'>"+parseFloat(result[0].stok_item).toLocaleString('id-ID', { maximumFractionDigits: 2})+"</td>";
                            data += "<td style='text-align:center;'><input type='text' class='form-control' id='qtyRowEditMask' autocomplete='off' data-a-dec=',' data-a-sep='.' value='"+qtyFixed+"' />";
                            data += "<input type='hidden' class='form-control inputEdit' id='qtyRowEdit' value='"+qtyFixed+"' /></td>";
                            data += "<td width='200px' style='text-align:center;'><input type='text' class='form-control' id='keteranganEdit' value='"+result[0].value5+"' /></td>";
                            data += "</tr>";
        ...
        function deleteDetailItem(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "/ProductionDelivery/DeleteDetail",
                        method: 'POST',
                        data: {
                            idDetail: id,
                            mode: "edit"
	    ...
	    $(document).on("click", "#btnEditItem", function(e) {
            ...
            if (parseFloat(qty) > parseFloat(stock)) {
                Swal.fire(
                    "Gagal!",
                    "Jumlah Item Tidak dapat melebihi stock !",
                    "warning"
                );
                return false;
            }
            ...
            if (errCount == 0) {
                Swal.fire({
                    ...
                    if(result.value) {
                        ...
                        $.ajax({
                            url: "/ProductionDelivery/UpdateDetail",
                            method: 'POST',
                            dataType : 'json',
                            data: {
                                idItem : idItem,
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: "/ProductionDelivery/GetListTerms",
                method: 'POST',
                data: {
                    target: "pengiriman_produksi",
                },
                success: function(result){
                    if (result.length > 0) {
        ...
        $("#list_terms").on('click', '.selectTerms', function() {
            ...
            $.ajax({
                url: "/ProductionDelivery/GetTerms",
                method: 'POST',
                data: {
                    idTemplate: id,
                },
        ...
        function footerDataForm(idDlv) {
            ...
            $.ajax({
                url: "/ProductionDelivery/GetDataFooter",
                method: 'POST',
                data: {
                    idProductionDelivery: idDlv,
                    mode: 'edit'
                },
                success: function(result){
                    if (result != "null") {
