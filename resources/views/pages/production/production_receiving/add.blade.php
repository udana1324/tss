			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h5 class="card-title text-white">Buat Penerimaan Produksi</h5>
					</div>
                    <form action="{{ route('ProductionReceiving.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        <div class="form-group">
                                            <label>No. Perintah Produksi :</label>
                                            <div>
                                                <select class="form-control select2 req" id="production_order" name="production_order">
                                                    <option label="Label"></option>
                                                </select>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan pembuatan penerimaan produksi?",
                icon: "warning",
        ...
        $("#supplier").on("change", function() {
            //getListProduct
            getSupplierProductionOrder($(this).val());
            ...
            $.ajax({
                ...
                success: function(result){
                    var datatable = $('#list_item').KTDatatable();
                        ...
                        datatable.setDataSourceParam('idProductionReceiving', '');
                        datatable.reload();
        ...
        function getSupplierProductionOrder(idSupplier) {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
