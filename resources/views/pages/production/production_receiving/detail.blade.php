...
@section('content')
	...
	@include('pages.alerts')
			<div class="content">
                <form action="{{ route('ProductionReceiving.Posting', $dataRcv->id) }}" class="form-horizontal" id="form_add" method="POST">
                {{ csrf_field() }}
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            ...
                            <div class="mt-2 mt-sm-0">
                                ...
                                @elseif($dataRcv->status_penerimaan == "posted")
                                    ...
                                    @endif
                                    @if($hakAkses->print == "Y")
                                        <a type="button" class="btn btn-primary mt-2 mt-sm-0" href='{{route('ProductionReceiving.Cetak', $dataRcv->id)}}' target="_blank">Cetak<i class="fas fa-print ml-2"></i></a>
                                    @endif
                                @endif
                            </div>
                        </div>
