			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary text-white header-elements-sm-inline">
						<h5 class="card-title font-weight-semibold">Ubah Kategori Supplier</h5>
					</div>
                    <form action="{{ route('SupplierCategory.update', $dataCategory->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
    ...
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '{{ url("/SupplierCategory") }}';
                    // Swal.fire(
                    //     "Deleted!",
