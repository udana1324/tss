	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom">
					...
					<div class="card-body">
						<form action="{{ route('Customer.update', $dataCustomer->id) }}" method="POST" id="form_add">
						{{ csrf_field() }}
                        @method('PUT')
									...
									<div class="col-md-6">
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control req" autocomplete="off" maxlength="20" onkeypress="return validasiTelp(event)" name="telp_cust" id="telp_cust" value="{{$dataCustomer->telp_customer}}">
													...
													-
													<input type="text" class="tlp form-control req" autocomplete="off" style="width:280px;display:inline-block;" maxlength="12" onkeypress="return validasiangka(event);" name="body_telp_cust" id="body_telp_cust"> --}}
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" autocomplete="off" maxlength="20" onkeypress="return validasiTelp(event)" name="fax_cust" id="fax_cust" value="{{$dataCustomer->fax_customer}}">
													{{-- <input type="text" class="fax form-control" autocomplete="off" style="width:150px; display:inline-block;" maxlength="3" onkeypress="return validasiangka(event);" name="head_fax_cust" id="head_fax_cust">
													-
													<input type="text" class="fax form-control" autocomplete="off" style="width:280px;display:inline-block;" maxlength="8" onkeypress="return validasiangka(event);" name="body_fax_cust" id="body_fax_cust"> --}}
											        <span class="form-text text-muted">Contoh : (999) 99999999</span>
												</div>
                                            </div>
									...
									<div class="col-md-6">
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
                                                <input type="text" class="form-control req" autocomplete="off" placeholder="Masukkan Nama Pelanggan" name="nama_cust" id="nama_cust" value="{{$dataCustomer->nama_customer}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="no-gutters">
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                        <input type="radio" id="jenis_cust_c" name="jenis_customer" value="C" {{ $dataCustomer->jenis_customer === "C" ? "checked" : "" }} />
                                                        <span></span>Perusahaan</label>
                                                        <label class="radio">
                                                        <input type="radio" id="jenis_cust_i" name="jenis_customer" value="I" {{ $dataCustomer->jenis_customer === "I" ? "checked" : "" }} />
											...
											<div class="form-group row">
												<label class="col-lg-3 col-form-label">NPWP Customer</label>
												<div class="col-lg-9">
										...
										<span class="form-text text-danger err" style="display:none;">*Harap masukkan no. npwp (16 digit) customer terlebih dahulu!</span>
                                            ...
                                            <div class="form-group row" id="rowKtp"  @if ($dataCustomer->jenis_customer == "C") style="display:none;" @endif>
												<label class="col-lg-3 col-form-label">No. KTP Pelanggan</label>
												<div class="col-lg-9">
													<input type="text" class="form-control" autocomplete="off" placeholder="Masukkan No. KTP Pelanggan" maxlength="16" name="ktp_cust" id="ktp_cust" value="{{$dataCustomer->ktp_customer}}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="email" class="form-control" autocomplete="off" placeholder="Masukkan Email Pelanggan" name="email_cust" id="email_cust" value="{{$dataCustomer->email_customer}}">
                                            ...
                                            <div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="number" class="form-control" autocomplete="off" placeholder="Masukkan Limit Piutang Pelanggan" name="limit_cust" id="limit_cust" value="{{$dataCustomer->limit_customer}}">
...
@section('scripts')
    <script type="text/javascript">
		...
		$("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan perubahan data Pelanggan?",
                icon: "warning",
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            ...
                            var datatable = $('#list_product').KTDatatable();
                                datatable.setDataSourceParam('id_customer', '{{$dataCustomer->id}}');
                                datatable.reload();
