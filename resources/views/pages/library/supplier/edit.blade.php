	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom">
					...
					<div class="card-body">
						<form action="{{ route('Supplier.update', $dataSupplier->id) }}" method="POST" id="form_add">
						{{ csrf_field() }}
                        @method('PUT')
									...
									<div class="col-md-6">
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control req" autocomplete="off" maxlength="20" onkeypress="return validasiTelp(event)" name="telp_supp" id="telp_supp" value="{{$dataSupplier->telp_supplier}}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" autocomplete="off" maxlength="20" onkeypress="return validasiTelp(event)" name="fax_supp" id="fax_supp" value="{{$dataSupplier->fax_supplier}}">
									...
									<div class="col-md-6">
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control req" autocomplete="off" placeholder="Masukkan Nama Supplier" name="nama_supp" id="nama_supp" value="{{$dataSupplier->nama_supplier}}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="email" class="form-control" autocomplete="off" placeholder="Masukkan Email Supplier" name="email_supp" id="email_supp" value="{{$dataSupplier->email_supplier}}">
...
@section('scripts')
    <script type="text/javascript">
		...
		$("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan perubahan data Supplier?",
                icon: "warning",
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            ...
                            var datatable = $('#list_product').KTDatatable();
                                datatable.setDataSourceParam('id_supplier', '{{$dataSupplier->id}}');
                                datatable.reload();
