	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom">
					...
					<div class="card-body">
						<form action="{{ route('Expedition.update', $dataExpedition->id) }}" method="POST" id="form_add">
                        {{ csrf_field() }}
                        @method('PUT')
									...
									<div class="col-md-6">
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
                                                <input type="text" class="form-control req" placeholder="Masukkan Nama Ekspedisi" name="nama_ekspedisi" id="nama_ekspedisi" value="{{$dataExpedition->nama_ekspedisi}}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
                                                    <input type="text" placeholder="Masukkan Nama Perusahaan Ekspedisi" class="form-control req" name="nama_perusahaan" id="nama_perusahaan" value="{{$dataExpedition->nama_perusahaan}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control" maxlength="14" onkeypress="return validasiangka(event);" name="telp_perusahaan" id="telp_perusahaan" autocomplete="off" value="{{$dataExpedition->telp_perusahaan}}">
...
@section('scripts')
    <script type="text/javascript">
		...
		$("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan perubahan Ekspedisi?",
                icon: "warning",
        ...
        function getAlamatDraft() {
			var datatable = $('#table_cabang').KTDatatable();
                datatable.setDataSourceParam('idExpedition','{{$dataExpedition->id}}');
                datatable.reload();
		}
