			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary text-white header-elements-sm-inline">
						<h5 class="card-title font-weight-semibold">Tambah Bank</h5>
					</div>
                    <form action="{{ route('Bank.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" maxlength="3" placeholder="Masukkan Kode Bank" id="kode_bank" name="kode_bank" class="form-control req" onkeypress='return validasiangka(event);'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" placeholder="Masukkan Nama Bank" id="nama_bank" name="nama_bank" class="form-control req">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" placeholder="Masukkan Deskripsi Bank" id="deskripsi_bank" name="deskripsi_bank" class="form-control req">
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-light-danger font-weight-bold mr-2" onclick="window.location.href = '{{ url('/Bank') }}';">Keluar <i class="flaticon2-cancel icon-sm"></i></button>
                            </div>
