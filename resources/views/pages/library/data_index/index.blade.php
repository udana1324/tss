        ...
        <div class="card card-custom">
            <div class="card-header bg-primary header-elements-sm-inline">
                <div class="card-title">
                    <h3 class="card-label text-white">Daftar Jenis Lokasi</h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Button-->
                    @if($hakAkses->add == "Y")
                    <button class="btn btn-primary btn-outline-white mr-2" onclick="window.location.href = '{{ url('/DataIndex/Add') }}';">
                ...
                columns: [
                    {
                        ...
                        template: function(row) {
                            return row.kode_index.toUpperCase();
                        },
                        autoHide: false,
                    }, {
                        field: 'nama_index',
                        ...
                        width: 'auto',
                        template: function(row) {
                            if (row.nama_parent == null) {
                                return "Lokasi Utama";
                            }
                            else {
                                return ucwords(row.nama_parent);
                            }
                        },
                        autoHide: false,
                    },
                    {
                        ...
                        template: function(row) {
                            ...
                            var txtAction = '<div class="dropdown dropdown-inline">';
                                ...
                                if (akses.edit == "Y") {
                                    txtAction += "<li class='nav-item'><a class='nav-link' href='{{route('DataIndex.edit', 'idModule')}}'><i class='nav-icon la la-edit'></i><span class='nav-text'>Ubah</span></a></li>";
                                }
                                if (akses.delete) {
