			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary text-white header-elements-sm-inline">
						<h5 class="card-title font-weight-semibold">Tambah Group Customer</h5>
					</div>
                    <form action="{{ route('CustomerGroup.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Kode Group" id="kode_group" name="kode_group" class="form-control req" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="Masukkan Nama Group" id="nama_group" name="nama_group" class="form-control req">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="checkbox-inline">
                                                    <label class="checkbox checkbox">
                                                        <input type="checkbox" class="checkFlag" value="1" id="Harga" checked>
                                                        <span></span>
                                                    </label>
                                                </div>
                                                <input type="hidden" id="flagHarga" name="flagHarga" class="form-control" value="1" readonly>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-light-danger font-weight-bold mr-2" onclick="window.location.href = '{{ url('/CustomerGroup') }}';">Keluar <i class="flaticon2-cancel icon-sm"></i></button>
                            </div>
