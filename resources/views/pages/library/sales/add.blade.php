			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary text-white header-elements-sm-inline">
						<h5 class="card-title font-weight-semibold">Tambah Sales</h5>
					</div>
                    <form action="{{ route('Sales.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" placeholder="Masukkan Nama Sales" id="nama_sales" name="nama_sales" class="form-control req" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="number" placeholder="Masukkan Telp Sales" id="telp_sales" name="telp_sales" class="form-control req">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="email" placeholder="Masukkan Email Sales" id="email_sales" name="email_sales" class="form-control req">
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-light-danger font-weight-bold mr-2" onclick="window.location.href = '{{ url('/Sales') }}';">Keluar <i class="flaticon2-cancel icon-sm"></i></button>
                            </div>
