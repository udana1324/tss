			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary text-white header-elements-sm-inline">
						<h5 class="card-title font-weight-semibold">Ubah Template Terms And Condition</h5>
					</div>
                    <form action="{{ route('TermsAndCondTemplate.update', $dataTerms->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control req" placeholder="Masukkan Nama Template" name="nama_template" id="nama_template" value="{{$dataTerms->nama_template}}">
...
@section('scripts')
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan perubahan Template?",
                icon: "warning",
                ...
                if(result.value) {
                    window.location.href = "{{ url('/TermsAndCondTemplate') }}";
                }
        ...
        $(document).ready(function () {
            ...
            $("#target_template").val("{{$dataTerms->target_template}}").trigger('change');
        });
