	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom card-sticky">
                    ...
                    <form action="{{ route('SalesOrder.Posting', $dataSalesOrder->id) }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <label class="col-form-label">{{strtoupper($dataSalesOrder->no_so)}}</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-5">
                                                <label class="col-form-label">{{$dataSalesOrder->no_po_customer}}</label>
                                            </div>
                                            <div class="col-lg-3 text-right" style="display: {{ $dataSalesOrder->path_po === '' ? 'none' : 'block' }};">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <label class="col-form-label">{{\Carbon\Carbon::parse($dataSalesOrder->tanggal_so)->format('d F Y')}}</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <label class="col-form-label">{{\Carbon\Carbon::parse($dataSalesOrder->tanggal_request)->format('d F Y')}}</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <label class="col-form-label">{{ $dataSalesOrder->metode_pembayaran === "cash" ? "Cash/Tunai" : "Kredit" }}</label>
                                            </div>
                                        </div>

                                        <div class="form-group row {{ $dataSalesOrder->metode_pembayaran === "cash" ? "d-none" : "" }}">
                                            <label class="col-lg-4 col-form-label">Durasi Jatuh Tempo (Hari) :</label>
                                            <div class="col-lg-8">
                                                <label class="col-form-label">{{$dataSalesOrder->durasi_jt}}</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                @if ($dataSalesOrder->flag_ppn == "N")
                                                <label class="col-form-label">Non PPn</label>
                                                @elseif ($dataSalesOrder->flag_ppn == "Y")
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="percentage" disabled="disabled" value="P" name="jenis_diskon" {{ $dataSalesOrder->jenis_diskon === "P" ? "checked" : "" }}  />
                                                            <span></span>Persentase
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" id="nominal" disabled="disabled" value="N" name="jenis_diskon" {{ $dataSalesOrder->jenis_diskon === "N" ? "checked" : "" }}  />
                                                            <span></span>Nominal
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6" id="discPercent" @if ($dataSalesOrder->jenis_diskon == "N") style="display:none;" @endif >
                                                ...
                                                <div>
                                                    <input type="text" class="form-control discount" onkeypress="return validasiAngka(event);" name="disc_percent" id="disc_percent" value="{{number_format($dataSalesOrder->persentase_diskon, 2, ',', '.')}}" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-6" id="discNominalDiv" @if ($dataSalesOrder->jenis_diskon == "P") style="display:none;" @endif >
                                                ...
                                                <div>
                                                    <input type="text" class="form-control discount" onkeypress="return validasiAngka(event);" name="disc_nominal" id="disc_nominal" value="{{number_format($dataSalesOrder->nominal_diskon, 2, ',', '.')}}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                @if($dataSalesOrder->metode_kirim == "delivery")
                                                <label class="col-form-label">Kirim</label>
                                                @elseif($dataSalesOrder->metode_kirim == "pickup")
                                                <label class="col-form-label">Ambil Sendiri</label>
                                                @elseif($dataSalesOrder->metode_kirim == "ekspedisi")
								...
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" onkeypress="return validasiDecimal(this,event);" name="dp" id="dp" value="{{ $dataSalesOrder->status_so === "draft" ? $dataSalesOrder->nominal_dp : number_format($dataSalesOrder->nominal_dp, 0, ',', '.') }}" {{ $dataSalesOrder->status_so === "draft" ? "" : "readonly" }}>
                                                    <div class="input-group-append" style="display: {{ $dataSalesOrder->status_so === 'draft' ? 'block' : 'none' }};">
                                        ...
                                        <div class="form-group" style="display: {{ $dataSalesOrder->status_so === 'draft' ? 'none' : 'block' }};">
                                            <label>Sisa Down Payment :</label>
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" onkeypress="return validasiDecimal(this,event);" name="sisaDp" id="sisaDp" value="{{number_format($dataSalesOrder->sisa_dp, 0, ',', '.')}}" {{ $dataSalesOrder->status === "draft" ? "" : "readonly" }}>
                                                </div>
                                            </div>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="status_so" id="status_so" value="{{strtoupper($dataSalesOrder->status_so)}}" readonly>
                                                </div>
                                            </div>
                                        </div>
										...
										<div class="form-group">
											...
											<div class="input-group">
        										<div class="col-12 pl-0">
        											<input type="text" id="revisi" class="form-control" value="{{ $dataSalesOrder->flag_revisi == "1" ? "Revisi" : "Tidak" }}" readonly>
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            ...
                            <div class="mt-2 mt-sm-0">
                                ...
                                @if($dataSalesOrder->status_so == "draft")
                                    ...
                                    @endif
                                @elseif($dataSalesOrder->status_so == "posted")
                                    <button type="button" class="btn btn-light-success btnSubmit" id="btn_delivery" value="kirim">Buat Pengiriman<i class="flaticon2-delivery-truck ml-2"></i></button>
                                    @if($delivery > 0)
                                        <button type="button" class="btn btn-light-info btnSubmit" id="btn_close" value="tutup">Tutup SO<i class="fas fa-file-upload ml-2"></i></button>
                                    @else
                                ...
                                @endif
                                @if($hakAkses->print == "Y")
								    <a type="button" class="btn btn-light btn-text-primary btn-hover-text-primary font-weight-bold" href='{{route('SalesOrder.Cetak', $dataSalesOrder->id)}}' target="_blank">Cetak SO<i class="fas fa-print ml-2 text-primary"></i></a>
								    @if($dataSalesOrder->status_so != "draft" || $dataSalesOrder->status_so != "batal")
    								    @if($dataSalesOrder->nominal_dp > 0)
                                        <a type="button" class="btn btn-outline-primary" href='{{route('SalesOrder.CetakInvDP', $dataSalesOrder->id)}}' target="_blank">Cetak Invoice DP<i class="fas fa-print ml-2"></i></a>
                                        @endif
                                        <a type="button" class="btn btn-primary" href='{{route('SalesOrder.CetakInvPelunasan', $dataSalesOrder->id)}}' target="_blank">Cetak Invoice Pelunasan<i class="fas fa-print ml-2"></i></a>
                                        <a type="button" class="btn btn-primary" href='{{route('SalesOrder.CetakInvPerforma', $dataSalesOrder->id)}}' target="_blank">Cetak Proforma Invoice<i class="fas fa-print ml-2"></i></a>
                                    @endif
								@endif
                            </div>
                        </div>
            ...
            $.ajax({
                ...
                success: function(result){
                    if (result != "null") {
                        ...
                        var jenisPPn = "{{$dataSalesOrder->flag_ppn}}";
                        var persenPPNInclude = (100 + parseFloat("{{$taxSettings->ppn_percentage}}")) / 100;
                        var persenPPNExclude = parseFloat("{{$taxSettings->ppn_percentage}}") / 100;
                        var jenisDisc = "{{$dataSalesOrder->jenis_diskon}}";
                        ...
                        if(jenisDisc == "P") {
                            persenDiskon = "{{$dataSalesOrder->persentase_diskon}}";
                            diskonNominal = parseFloat(subtotalFixed) * (parseFloat(persenDiskon) / 100);
                        }
                        else if(jenisDisc == "N") {
                            diskonNominal = "{{$dataSalesOrder->nominal_diskon}}";
                        }
