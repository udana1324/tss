			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Buat Pesanan Penjualan Baru</h6>
					</div>
                    <form action="{{ route('SalesOrderInternal.store') }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-lg-6">
									<fieldset>
                                        ...
                                        <div class="form-group">
											...
											<div class="input-group">
                                                ...
                                                <input type="text" class="form-control form-control-solid" placeholder="Nomor akan dibuat otomatis oleh sistem" name="kode_so" id="kode_so" readonly>
											</div>
										</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="po_customer" id="po_customer">
                                        ...
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-md-6" id="durasiJT" style="display: none;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6" id="discNominalDiv" style="display: none;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" value="delivery" name="metode_kirim" id="metode_kirim_delivery" checked />
                                                            <span></span>Kirim
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" value="pickup" name="metode_kirim" id="metode_kirim_pickup" />
                                                            <span></span>Ambil Sendiri
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" value="ekspedisi" name="metode_kirim" id="metode_kirim_ekspedisi" />
                                                            <span></span>Ekspedisi
                                                        </label>
                                                    </div>
                                                    <div class="input-group-append ml-5" id="blokEkspedisi" style="display: none;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <textarea class="form-control elastic" id="tnc" name="tnc" rows="3" placeholder="Ketik Syarat & Ketentuan Penjualan Disini atau gunakan Template pada tombol Template"></textarea>
                                                    <div class="input-group-append">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header bg-primary">
                                        ...
                                        <h5 class="modal-title text-white">Unggah berkas / gambar PO</h5>
                                    </div>
                                    <div class="modal-body">
                                        <div class="form-group row">
                                            <label class="col-12 col-form-label text-center">Klik gambar pensil untuk mengunggah berkas / gambar :</label>
                                            <div class="col-12 text-center">
                                                <div class="image-input image-input-outline" id="file_po">
                                                    ...
                                                    <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Unggah berkas">
                                                        <i class="fa fa-pen icon-sm text-muted"></i>
                                                        <input type="file" name="file_po_customer" accept=".png, .jpg, .jpeg, .pdf" />
                                                        <input type="hidden" name="file_po_customer_remove" />
                                                    </label>
                                                    <span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="cancel" data-toggle="tooltip" title="Hapus berkas">
                                                        <i class="ki ki-bold-close icon-xs text-muted"></i>
                                                    </span>
                                                </div>
                                                <span class="form-text text-muted">*Tipe berkas yang diperbolehkan: png, jpg, jpeg, pdf</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="modal-footer">
						                <button type="button"class="btn btn-light me-3" data-dismiss="modal">Tutup</button>
                                    </div>
                                </div>
                            </div>
                        </div>
				...
				<div id="modal_list_alamat" class="modal fade">
				    <div class="modal-dialog modal-xl">
					    <div class="modal-content">
						    <div class="modal-header bg-primary">
							    <h5 class="modal-title text-white">Daftar Alamat Customer</h5>
						    </div>
						    <div class="modal-body">
							    <form >
								    <!--<table class="table table-hover table-responsive-xl" id="list_alamat" width="100%">-->
				    ...
				    <div class="modal-dialog modal-lg">
					    <div class="modal-content">
						    <div class="modal-header bg-primary">
							    ...
							    <h5 class="modal-title text-white">Daftar Template Terms</h5>
						    </div>
						    <div class="modal-body">
							    <form >
							        <table class="table table-hover table-responsive-xl" id="list_terms" width="100%">
									    <thead class="thead-light">
										    <tr class="text-left">
											    <th class="d-none">ID</th>
												<th>Nama Terms</th>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#ekspedisi').select2({
                allowClear: true,
                placeholder: "Silahkan pilih ekspedisi"
            });
            ...
            $("#tanggal_so_picker").datepicker('setDate', new Date());

            var idCust = "{{$idCust}}";
            if ($("#mode").val() == "so" && idCust != "") {
                ...
                $.ajax({
                    url: "/SalesOrderInternal/SetDetail",
                    method: 'POST',
                    data: {
                        idSo: '',
                        idQuotation: "{{$idQuo}}",
                    ...
                    success: function(result){
                        if (result != "") {
                            var datatable = $('#list_item').KTDatatable();
                                datatable.setDataSourceParam('idSalesOrderInternal', '');
                                datatable.reload();
        ...
        $(".pickerTgl").on('change', function() {
            ...
            if ($("#tanggal_req").val() != "") {
                if (selisih < 0) {
                    ...
                    $("#tanggal_req_picker").attr("class","form-control pickerTgl is-invalid");
                }
            }
            if ($("#tanggal_req_picker").val() != "" && $("#tanggal_so_picker").val() != ""){
                $("#tanggal_req_picker").attr("class","form-control pickerTgl is-valid");
                $("#tanggal_so_picker").attr("class","form-control pickerTgl is-valid");
            }
        });
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan pembuatan pesanan penjualan?",
                icon: "warning",
        ...
        $("#customer").on("change", function() {
            ...
            $.ajax({
                url: "/SalesOrderInternal/GetDefaultAddress",
                method: 'POST',
                data: {
            ...
            // });
            // $.ajax({
            //     url: "/SalesOrderInternal/GetCustomerAddress",
            //     method: 'POST',
            //     data: {
            //         id_customer: $(this).val(),
            //     },
            ...
            //                     var kota = result[i].kota;
            //                     var outlet = result[i].nama_outlet;
            //                     var pic = result[i].pic_alamat;
            //                     var tlpPic = result[i].telp_pic;
            //                     var data="<tr>";
            //                         data +="<td class='d-none'>"+idAlamat+"</td>";
            //                         data +="<td>"+ucwords(alamat)+"</td>";
            //                         data +="<td>"+kota+"</td>";
            //                         data +="<td>"+outlet+"</td>";
            //                         data +="<td>"+ucwords(pic)+"</td>";
            //                         data +="<td>"+tlpPic+"</td>";
            //                         data +="<td class='text-center'><button type='button' data-dismiss='modal' class='btn btn-primary btn-icon select'>Pilih</button></td>";
            //                         data +="</tr>";
            ...
            $.ajax({
                url: "/SalesOrderInternal/GetCustomerPreviousOrder",
                method: 'POST',
                data: {
                    id_customer: $(this).val(),
                },
            ...
            $.ajax({
                url: "/SalesOrderInternal/ResetDetail",
                method: 'POST',
                data: {
                    idSO: 'DRAFT',
                },
        ...
        $("#product").on("change", function() {
            ...
            $.ajax({
                url: "/SalesOrderInternal/GetSatuan",
                method: 'POST',
                data: {
                    idProduct: $(this).val(),
                },
        ...
        $("#productUnit").on("change", function() {
            ...
            $.ajax({
                url: "/SalesOrderInternal/GetDataItem",
                method: 'POST',
                data: {
        ...
        function getCustomerProduct(idCustomer) {
            ...
            $.ajax({
                url: "/SalesOrderInternal/GetProductByCustomer",
                method: 'POST',
                data: {
        ...
        $("#list_product").on('click', 'table .addToList', function() {
            ...
            Swal.fire({
                ...
                if(result.value) {
                    ...
                    $.ajax({
                        url: "/SalesOrderInternal/AddCustomerProduct",
                        method: 'POST',
                        data: {
                            id_item: idItem,
                            id_customer: idCustomer
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_product').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/SalesOrderInternal/GetProduct',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#list_riwayat').KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: '/SalesOrderInternal/GetProductHistory',
                            method: 'POST',
                            headers : {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                            },
                ...
                success: function(result){
                    if (result.length > 0) {
                        ...
                        var data = "<tr>";
                            ...
                            data += "<td class='d-none'><input type='text' class='form-control' id='idItemEdit' value='"+result[0].id_item+"' /></td>";
                        ...
                        $.ajax({
                            ...
                            method: 'POST',
                            data: {
                                id_product: $("#idItemEdit").val(),
                                id_satuan: $("#idSatuanEdit").val(),
                                id_customer: $("#customer option:selected").val()
                            },
                            success: function(result){
                                if (result != null || result.length > 0) {
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: "/SalesOrderInternal/GetListTerms",
                method: 'POST',
                data: {
                    target: "penjualan",
                },
        ...
        $("#list_terms").on('click', '.selectTerms', function() {
            ...
            $.ajax({
                url: "/SalesOrderInternal/GetTerms",
                method: 'POST',
                data: {
                    idTemplate: id,
                },
