	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom card-sticky">
                    ...
                    <form action="{{ route('SalesOrderInternal.update', $dataSalesOrderInternal->id) }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
									...
									<fieldset>
                                        ...
                                        <div class="form-group">
											...
											<div class="input-group">
                                                ...
                                                <input type="text" class="form-control form-control-solid" placeholder="Nomor akan dibuat otomatis oleh sistem" name="kode_so" id="kode_so" value="{{strtoupper($dataSalesOrderInternal->no_so)}}" readonly>
											</div>
										</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="po_customer" id="po_customer" value="{{$dataSalesOrderInternal->no_po_customer}}">
                                            ...
                                            <div class="col-lg-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="cash" value="cash" name="metode_bayar" {{ $dataSalesOrderInternal->metode_pembayaran === "cash" ? "checked" : "" }} />
                                                            <span></span>Cash/Tunai
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" id="credit" value="credit" name="metode_bayar" {{ $dataSalesOrderInternal->metode_pembayaran === "credit" ? "checked" : "" }} />
                                                            <span></span>Kredit
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6" id="durasiJT" @if ($dataSalesOrderInternal->metode_pembayaran == "cash") style="display:none;" @endif>
											<label>Durasi (Hari) :</label>
    											<div>
    												<input type="text" class="form-control" maxlength="4" onkeypress="return validasiAngka(event);" name="durasi_jt" id="durasi_jt" value="{{$dataSalesOrderInternal->durasi_jt}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-gutters">
                                                <div class="radio-inline">
                                                    <label class="radio">
                                                    <input type="radio" id="statPpn_n" name="status_ppn" value="N" {{ $dataSalesOrderInternal->flag_ppn === "N" ? "checked" : "" }} />
                                                    <span></span>Non PPn</label>
                                                    <label class="radio">
                                                    <input type="radio" id="statPpn_y" name="status_ppn" value="Y" {{ $dataSalesOrderInternal->flag_ppn === "Y" ? "checked" : "" }} />
                                                    <span></span>PPn Excl.</label>
                                                    <label class="radio">
                                                    <input type="radio" id="statPpn_i" name="status_ppn" value="I" {{ $dataSalesOrderInternal->flag_ppn === "I" ? "checked" : "" }} />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 mb-5">
                                                ...
                                                <div>
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" id="percentage" value="P" name="jenis_diskon" {{ $dataSalesOrderInternal->jenis_diskon === "P" ? "checked" : "" }} />
                                                            <span></span>Persentase
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" id="nominal" value="N" name="jenis_diskon" {{ $dataSalesOrderInternal->jenis_diskon === "N" ? "checked" : "" }} />
                                                            <span></span>Nominal
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6" id="discPercent" @if ($dataSalesOrderInternal->jenis_diskon == "N") style="display:none;" @endif>
                                                ...
                                                <div>
                                                    <input type="text" class="form-control discount" onkeypress="return validasiAngka(event);" name="disc_percent" id="disc_percent" value="{{$dataSalesOrderInternal->persentase_diskon}}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6" id="discNominalDiv" @if ($dataSalesOrderInternal->jenis_diskon == "P") style="display:none;" @endif >
                                                ...
                                                <div>
                                                    <input type="text" class="form-control discount" onkeypress="return validasiAngka(event);" name="disc_nominal" id="disc_nominal" value="{{$dataSalesOrderInternal->nominal_diskon}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <div class="radio-inline">
                                                        <label class="radio">
                                                            <input type="radio" value="delivery" name="metode_kirim" id="metode_kirim_delivery" {{ $dataSalesOrderInternal->metode_kirim === "delivery" ? "checked" : "" }} />
                                                            <span></span>Kirim
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" value="pickup" name="metode_kirim" id="metode_kirim_pickup" {{ $dataSalesOrderInternal->metode_kirim === "pickup" ? "checked" : "" }} />
                                                            <span></span>Ambil Sendiri
                                                        </label>
                                                        <label class="radio">
                                                            <input type="radio" value="ekspedisi" name="metode_kirim" id="metode_kirim_ekspedisi" {{ $dataSalesOrderInternal->metode_kirim === "ekspedisi" ? "checked" : "" }} />
                                                            <span></span>Ekspedisi
                                                        </label>
                                                    </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                ...
                if(result.value) {
                    ...
                    // });
                    // $.ajax({
                    //     url: "/SalesOrderInternal/RestoreDetail",
                    //     method: 'POST',
                    //     data: {
        ...
        $(document).ready(function () {
            $("#customer").val("{{$dataSalesOrderInternal->id_customer}}").trigger('change');
            var metodeBayar = "{{$dataSalesOrderInternal->metode_pembayaran}}";
            if (metodeBayar == "cash") {
                $("#durasiJT").hide();
            }
            else {
            ...
            footerDataForm('{{$dataSalesOrderInternal->id}}');
            $("#tanggal_so_picker").datepicker("setDate", new Date("{{$dataSalesOrderInternal->tanggal_so}}"));
            $("#tanggal_req_picker").datepicker("setDate", new Date("{{$dataSalesOrderInternal->tanggal_request}}"));
            $("#mode").val("edit");
        });
