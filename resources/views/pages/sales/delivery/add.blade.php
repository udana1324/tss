			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h5 class="card-title text-white">Buat Pengiriman</h5>
					</div>
                    <form action="{{ route('Delivery.store') }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group row d-none">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text" class="form-control bg-slate-600 border-slate-600 border-1" placeholder="Auto Generated" name="kode_delivery" id="kode_delivery" readonly>
                                            </div>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" name="alamat" id="alamat" style="resize:none;" placeholder="Silahkan Pilih Sales Order Terlebih Dahulu" readonly></textarea>
                                        ...
                                        <div class="form-group" id="divTnc" style="display: none;">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <textarea class="form-control elastic" id="tnc" name="tnc" rows="3" placeholder="Ketik Syarat & Ketentuan Pengiriman Disini atau gunakan Template pada tombol Template" readonly></textarea>
                                                    <div class="input-group-append">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control"  name="metode_pengiriman" id="metode_pengiriman" readonly>
                                            </div>
                                        </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan pembuatan pengiriman barang?",
                icon: "warning",
            ...
            $.ajax({
                ...
                success: function(result){
                    var datatable = $('#list_item').KTDatatable();
                        ...
                        datatable.setDataSourceParam('idDelivery', '');
                        datatable.reload();
        ...
        function getCustomerSalesOrder(idCustomer) {
            ...
            $.ajax({
                ...
                success: function(result){
                    ...
                    if ($("#mode").val() == "kirim") {
                        $("#salesOrder").val("{{$idSo}}").trigger("change");
                        $("#mode").val("tambah");
                        var datatable = $('#list_item').KTDatatable();
