			...
			<div class="content">
				...
				<div class="card card-custom">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h5 class="card-title text-white">Ubah Invoice Penjualan</h5>
					</div>
                    <form action="{{ route('SalesInvoice.update', $dataInv->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
									...
									<fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                ...
                                                <input type="text" class="form-control" name="tanggal_inv_picker" id="tanggal_inv_picker" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                ...
                                                <input type="text" class="form-control" name="value_diskonMask" id="value_diskonMask" value="{{number_format($dataInv->value_diskon, 2, ',', '.')}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="radio-inline">
                                                    <label class="radio">
                                                        <input type="radio" id="termsSo" value="use" name="terms_usage" {{ $dataInv->flag_terms_so == 1 ? "checked" : "" }} />
                                                        <span></span>Sales Order
                                                    </label>
                                                    <label class="radio">
                                                        <input type="radio" id="buatTerms" value="new" name="terms_usage" {{ $dataInv->flag_terms_so == 0 ? "checked" : "" }} />
                                                        <span></span>Buat Baru
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group" id="divTnc">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <textarea class="form-control" id="tnc" name="tnc" rows="3" placeholder="Ketik Syarat & Ketentuan Pengiriman Disini atau gunakan Template pada tombol Template">@foreach($dataTerms as $terms){{ucwords($terms->terms_and_cond)}}@endforeach</textarea>
				    ...
				    <div class="modal-dialog modal-xl">
					    <div class="modal-content">
						    <div class="modal-header bg-primary">
							    ...
							    <h5 class="modal-title">Detail Delivery</h5>
						    </div>
						    <div class="modal-body">
                                <div class="mb-7">
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#customer").val("{{$dataInv->id_customer}}").trigger("change");
            $("#company_account").val("{{$dataInv->id_rekening}}").trigger("change");
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin membatalkan perubahan invoice penjualan?",
                icon: "warning",
                ...
                if(result.value) {
                    ...
                    $.ajax({
                        url: "/SalesInvoice/RestoreDetail",
                        method: 'POST',
                        data: {
                            idInv: '{{$dataInv->id}}'
                        },
        ...
        function getCustomerSalesOrder(idCustomer) {
            ...
            $.ajax({
                ...
                success: function(result){
                    ...
                    if ($("#mode").val() == "load") {
                        $("#SalesOrder").val("{{$dataInv->id_so}}").trigger("change");
                        $("#mode").val("edit");
                        var datatable = $('#list_item').KTDatatable();
                            datatable.setDataSourceParam('idInvoice', '{{$dataInv->id}}');
                            datatable.reload();
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            var txtAction = "<a href='#' class='btn btn-sm btn-clean btn-icon' data-toggle='modal' data-target='#modal_detail_delivery' title='Detail' onclick='viewDetailItem("+row.value2+");return false;'>";
