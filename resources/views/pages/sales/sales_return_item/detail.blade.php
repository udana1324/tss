			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Detail Retur Penjualan (Barang)</h6>
					</div>
                    <form action="{{ route('SalesReturnItem.Posting', $dataRetur->id) }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
									<fieldset>
                                        ...
                                        <div class="form-group row">
                                            <label  class="col-lg-4 col-form-label">No. Surat Jalan Retur :</label>
                                            <div class="col-lg-8">
                                                <label class="col-form-label">{{$dataRetur->no_dokumen_retur}}</label>
                                            </div>
                                        </div>
                        ...
                        <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                            ...
                            <div class="mt-2 mt-sm-0">
                                ...
                                @elseif($dataRetur->status_retur == "posted")
                                    @if($dataRetur->flag_nota == 0)
                                    <button type="button" class="btn btn-secondary mt-2 mt-sm-0 btnSubmit" id="btn_nota" value="nota">Buat Nota Retur<i class="fas fa-file-invoice ml-2"></i></button>
                                    @endif
                                ...
                                @endif
                                @if($hakAkses->print == "Y")
								    <a type="button" class="btn btn-primary mt-2 mt-sm-0" href='{{route('SalesOrder.Cetak', $dataRetur->id)}}' target="_blank">Cetak Surat Retur<i class="fas fa-print ml-2"></i></a>
								@endif
                            </div>
                        </div>
                    </form>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin kembali ke daftar retur penjualan (barang)?",
                icon: "warning",
        ...
        $(".btnSubmit").on("click", function(e){
            ...
            Swal.fire({
                title: ucwords(btn) + " Retur Penjualan (Barang)?",
                text: "Apakah yakin ingin melakukan " + ucwords(btn) +" Retur Penjualan (Barang)?",
                icon: "warning",
                showCancelButton: true,
                confirmButtonText: "Ya",
                cancelButtonText: "Tidak",
