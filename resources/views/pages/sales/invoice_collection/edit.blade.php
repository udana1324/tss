	...
	@include('pages.alerts')
			<div class="content">
				...
				<div class="card card-custom">
                    ...
                    <form action="{{ route('SalesInvoiceCollection.update', $dataCollection->id) }}" class="form-horizontal" id="form_add" method="POST">
					    <div class="card-body">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
										...
										<div class="form-group">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" name="alamat" id="alamat" style="resize:none;" readonly>{{ucwords($dataCollection->alamat_customer)}}</textarea>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#customer").val("{{$dataCollection->id_customer}}").trigger("change");
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                ...
                if(result.value) {
                    ...
                    $.ajax({
                        url: "/SalesInvoiceCollection/RestoreDetail",
                        method: 'POST',
                        data: {
