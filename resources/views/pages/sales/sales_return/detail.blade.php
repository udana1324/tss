			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Detail Retur Penjualan</h6>
					</div>
                    <form action="{{ route('SalesReturn.Posting', $dataRetur->id) }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
...
@section('scripts')
    <script type="text/javascript">
        ...
        $("#cancel").on('click', function(e) {
            Swal.fire({
                title: "Batal?",
                text: "Apakah anda ingin kembali ke daftar retur penjualan?",
                icon: "warning",
        ...
        $(".btnSubmit").on("click", function(e){
            ...
            Swal.fire({
                title: ucwords(btn) + " Retur Penjualan?",
                text: "Apakah yakin ingin melakukan " + ucwords(btn) +" Retur Penjualan?",
                icon: "warning",
                showCancelButton: true,
                confirmButtonText: "Ya",
                cancelButtonText: "Tidak",
