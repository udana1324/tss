			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Laporan Barang Masuk</h6>
					</div>
                    <form action="{{ route('ReceivingReport.Export') }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
					...
					<div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2> <strong><p>Mutasi Barang Masuk</p></strong></h2>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <h4><strong>TOTAL BARANG MASUK : <p style="display: inline-block;" id="ttlBarang"></p></strong></h4>
                            </div>
                        </div>
                ...
                if (errCount == 0) {
                    Swal.fire({
                        ...
                        if(result.value) {
                            ...
                            $.ajax({
                                url: "/ReceivingReport/GetReceivingReport",
                                method: 'POST',
                                data: {
                                    ...
                                    if (result.length > 0) {
                                        ...
                                        if (result.length > 0) {
                                            for (var i = 0; i < result.length;i++) {
                                                var noDo = result[i].kode_penerimaan;
                                                ...
                                                var data="<tr>";
                                                    ...
                                                    data +="<td style='text-align:left;'>"+namaSupplier+"</td>";
