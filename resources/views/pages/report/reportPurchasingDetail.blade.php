			...
			<div class="content">
				...
				<div class="card card-custom card-sticky">
					<div class="card-header bg-primary header-elements-sm-inline">
						<h6 class="card-title text-white">Laporan Pembelian Detail</h6>
					</div>
                    <form action="{{ route('ReportPurchasingDetail.Export') }}" class="form-horizontal" id="form_add" method="POST" enctype="multipart/form-data">
					    <div class="card-body">
                            {{ csrf_field() }}
                            <div class="row">
								<div class="col-md-6">
					...
					<div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2> <strong><p>Laporan Pembelian Detail</p></strong></h2>

                                <h3> <strong><p id="namaSupplier">Nama Supplier</p></strong></h3>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <h5>Total Transaksi Pembelian : <p style="display: inline-block;" id="ttlFaktur"></p></h5>
                            </div>
                        </div>
                        <br>
                    </div>
                ...
                if (errCount == 0) {
                    Swal.fire({
                        ...
                        if(result.value) {
                            ...
                            $.ajax({
                                url: "/ReportPurchasingDetail/GetPurchasingReportDetail",
                                method: 'POST',
                                data: {
                                    ...
                                    if (result.length > 0) {
                                        ...
                                        if (result.length > 0) {
                                            for (var i = 0; i < result.length;i++) {
                                                var noRcv = result[i].kode_penerimaan;
                                                var noPo = result[i].no_po;
                                                ...
                                                var harga = result[i].harga_beli;
                                                var namaSupplier = result[i].nama_supplier;

                                                var data="<tr>";
                                                    data +="<td style='text-align:center;'>"+formatDate(tgl)+"</td>";
                                                    data +="<td style='text-align:center;'>"+namaSupplier+"</td>";
                                                    data +="<td style='text-align:center;'>"+noRcv.toUpperCase()+"<br>"+"<span class='label label-primary label-inline label-round'>" + noPo.toUpperCase() + "</span>"+"<br>"+"<span class='label label-primary label-inline label-round'>" + kodeInv.toUpperCase() + "</span>"+"</td>";
                                            ...
                                            var txt = "";
                                            $("#namaSupplier").text($("#supplier option:selected").html());
